...
subscriptions.conf(5) — Linux manual page
=========================================
...
::
          ...
          subscriptions that are active.  It is normally located in the
          /etc/cups directory and is maintained by the cupsd(8) program.
...
::
          ...
          mime.convs(5), mime.types(5), printers.conf(5), CUPS Online Help
...
::
   ...
   26 April 2019                     CUPS             subscriptions.conf(5)
