...
::
          ...
          This file contains a list of files, one per line.  They should be
          listed as absolute pathnames, and should exist in the binary
          package, otherwise dpkg(1) will ignore them (although by default
          dpkg-deb(1) will refuse to build such binary packages).  Trailing
...
::
   ...
   1.19.6-2-g6e42d5               2019-03-25               deb-conffiles(5)
