...
dh_auto_test(1) — Linux manual page
===================================
...
::
          ...
          dh_auto_test [build system options] [debhelper options]
          [-- params]
...
::
          ...
          dh_auto_test is a debhelper program that tries to automatically
          ...
          example, if there's a Makefile and it contains a test or check
          target, then this is done by running make (or MAKE, if the
          environment variable is set). If the test suite fails, the
          command will exit nonzero. If there's no test suite, it will exit
          ...
          dh_auto_test at all, and just run the test suite manually.
...
::
          ...
          -- params
              ...
              that dh_auto_test usually passes.
...
::
          ...
          If the DEB_BUILD_OPTIONS environment variable contains nocheck,
...
::
   ...
   13.0.1                         2020-05-16                DH_AUTO_TEST(1)
