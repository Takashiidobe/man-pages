...
flatpak-permissions(1) — Linux manual page
==========================================
...
::
          ...
          When called without arguments, lists all the entries in all
          ...
          lists the entry in the named table for the given object ID.
