...
lttng-set-session(1) — Linux manual page
========================================
...
::
   ...
   LTTNG-SET-SESSION(1)          LTTng Manual          LTTNG-SET-SESSION(1)
...
::
          ...
          be specified in other commands. See lttng-create(1) for more
...
::
          ...
          lttng-create(1), lttng-destroy(1), lttng(1)
...
::
   ...
   LTTng 2.12.0-pre               10/29/2018           LTTNG-SET-SESSION(1)
