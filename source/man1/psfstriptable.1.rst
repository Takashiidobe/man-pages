...
psfstriptable(1) — Linux manual page
====================================
...
::
          ...
          psfstriptable - remove the embedded Unicode character table from
          a console font
...
::
          ...
          writes the result to outfile.  An input file name of "-" denotes
