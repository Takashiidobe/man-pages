...
dh_update_autotools_config(1) — Linux manual page
=================================================
...
::
          ...
          dh_update_autotools_config replaces all occurrences of config.sub
          and config.guess in the source tree by the up-to-date versions
          found in the autotools-dev package.  The original files are
          backed up and restored by dh_clean.
...
::
   ...
   13.0.1                         2020-05-16  DH_UPDATE_AUTOTOOLS_CONFIG(1)
