...
pcp2elasticsearch(1) — Linux manual page
========================================
...
::
   ...
   PCP2ELASTICSEARCH(1)     General Commands Manual    PCP2ELASTICSEARCH(1)
...
::
          ...
          applicable with pcp2elasticsearch as well.
...
::
          ...
          pmRegisterDerived(3), LOGARCHIVE(5), pcp.conf(5), PMNS(5) and
          pmrep.conf(5).
