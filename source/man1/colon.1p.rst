...
::
          ...
          This utility shall only expand command arguments.  It is used
          when a command is needed, as in the then condition of an if
...
::
          ...
          have variable assignments and redirections associated with it,
          such as:
...
::
   ...
   IEEE/The Open Group               2017                         COLON(1P)
