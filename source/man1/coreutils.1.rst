...
::
   ...
   COREUTILS(1)                  User Commands                 COREUTILS(1)
...
::
          ...
          Execute the PROGRAM_NAME built-in program with the given
          PARAMETERS.
...
::
          ...
          or available locally via: info '(coreutils) Multi-call
          invocation'
...
::
   ...
   GNU coreutils 8.32             March 2020                   COREUTILS(1)
