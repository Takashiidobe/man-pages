...
lttng-metadata(1) — Linux manual page
=====================================
...
::
   ...
   LTTNG-METADATA(1)             LTTng Manual             LTTNG-METADATA(1)
...
::
          ...
          lttng-metadata - Manage an LTTng tracing session's metadata
          generation
...
::
              ...
              Warning
              This command is deprecated; it has been replaced by lttng
              regenerate metadata (see lttng-regenerate(1)).
...
::
          ...
          The lttng metadata regenerate command can only be used on kernel
...
::
   ...
   LTTng 2.12.0-pre               10/29/2018              LTTNG-METADATA(1)
