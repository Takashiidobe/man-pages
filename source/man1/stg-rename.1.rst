...
stg-rename(1) — Linux manual page
=================================
...
::
          ...
          Rename <oldpatch> into <newpatch> in a series. If <oldpatch> is
          not given, the top-most patch will be renamed.
...
::
   ...
   StGit 1.0-10-ga6b3             08/27/2021                  STG-RENAME(1)
