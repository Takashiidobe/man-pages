...
stg-unhide(1) — Linux manual page
=================================
...
::
   ...
   STG-UNHIDE(1)                 StGit Manual                 STG-UNHIDE(1)
...
::
          ...
          Unhide a hidden range of patches so that they are shown in the
          plain stg series command output.
...
::
   ...
   StGit 1.0-10-ga6b3             08/27/2021                  STG-UNHIDE(1)
