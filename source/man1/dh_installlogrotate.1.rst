...
dh_installlogrotate(1) — Linux manual page
==========================================
...
::
          ...
          dh_installlogrotate is a debhelper program that is responsible
          for installing logrotate config files into etc/logrotate.d in
          package build directories.  Files named debian/package.logrotate
          are installed.
...
::
   ...
   13.0.1                         2020-05-16         DH_INSTALLLOGROTATE(1)
