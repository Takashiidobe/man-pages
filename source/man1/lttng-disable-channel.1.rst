...
lttng-disable-channel(1) — Linux manual page
============================================
...
::
          ...
          which a channel is disabled using lttng disable-channel can be
...
::
      ...
      Target
          -s SESSION, --session=SESSION
              Disable channels in the tracing session named SESSION instead
...
::
   ...
   LTTng 2.12.0-pre               10/29/2018          LTTNG-DISABLE-CHAN(1)
