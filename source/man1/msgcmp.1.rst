...
::
          ...
          Compare two Uniforum style .po files to check that both contain
          ...
          This is useful for checking that you have translated each and
...
::
          ...
          The full documentation for msgcmp is maintained as a Texinfo
          manual.  If the info and msgcmp programs are properly installed
...
::
   ...
   GNU gettext-tools 20200704      July 2020                      MSGCMP(1)
