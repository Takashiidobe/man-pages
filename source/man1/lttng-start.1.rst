...
lttng-start(1) — Linux manual page
==================================
...
::
          ...
          the specific configuration of the tracing session in which
          tracing is started. See lttng-create(1) for different session
          modes.

          A tracing session with running tracers is said to be active.
          Active tracing sessions can return to the inactive state using
          the lttng-stop(1) command.

          If SESSION is omitted, the LTTng tracers are started for the
...
::
   ...
   LTTng 2.12.0-pre               10/29/2018                 LTTNG-START(1)
