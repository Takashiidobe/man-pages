...
lttng-status(1) — Linux manual page
===================================
...
::
   ...
   LTTNG-STATUS(1)               LTTng Manual               LTTNG-STATUS(1)
...
::
          ...
          where CURSESSION is the name of the current tracing session. Use
          lttng-set-session(1) to set the current tracing session.
...
::
   ...
   LTTng 2.12.0-pre               10/29/2018                LTTNG-STATUS(1)
