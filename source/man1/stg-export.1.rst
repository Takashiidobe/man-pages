...
::
          ...
          to patches-<branch>) in a standard unified GNU diff format. A
          template file (defaulting to .git/patchexport.tmpl or
...
::
   ...
   StGit 1.0-10-ga6b3             08/27/2021                  STG-EXPORT(1)
