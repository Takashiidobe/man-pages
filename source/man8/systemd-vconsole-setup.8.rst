...
systemd-vconsole-setup.service(8) — Linux manual page
=====================================================
...
::
   ...
   SYSTEMD-VCONSOLE-SETUP.SERVICE(8)sole-setup.serviceSOLE-SETUP.SERVICE(8)
...
::
          ...
          specific one. When the system is booting up, it's called by
          systemd-udevd(8) during VT console subsystem initialization.
          Also, systemd-localed.service(8) invokes it as needed when
          language or console changes are made. Internally, this program
          calls loadkeys(1) and setfont(8).
...
::
   ...
   systemd 249                            SYSTEMD-VCONSOLE-SETUP.SERVICE(8)
