...
::
   ...
   MAIL.MDA(8)            BSD System Manager's Manual           MAIL.MDA(8)
...
::
        ...
        mail.mda executes the program and its parameters.  The program must
        read from the standard input up to an end-of-file and acknowledge
        delivery success or failure with its exit status.
...
::
        ...
        The mail.mda utility exits 0 on success, and >0 if an error occurs.
