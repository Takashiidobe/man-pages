...
| <#KERNEL_COMMAND_LINE_OPTIONS>`__ |                                   |
...
::
   ...
   SYSTEMD-NETWORK-GENERATOR.SERVICE(8)generator.serviceENERATOR.SERVICE(8)
...
::
          ...
          translates ip= and the related settings on the kernel command
          line (see below) into systemd.network(5), systemd.netdev(5), and
