...
yum-updatesd(8) — Linux manual page
===================================
...
::
          ...
          to be applied to your system.  This notification can be done
          either via syslog, email or over dbus.  Configuration is done via
          the yum-updatesd.conf(5)  file.
