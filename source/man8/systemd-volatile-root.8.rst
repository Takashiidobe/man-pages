...
::
   ...
   SYSTEMD-VOLATILE-ROOT.SERVICE(8)latile-root.serviceATILE-ROOT.SERVICE(8)
...
::
          ...
          command line. This service runs only in the initial RAM disk
          ("initrd"), before the system transitions to the host's root
          directory. Note that this service is not used if
          "systemd.volatile=state" is used, as in that mode the root
...
::
   ...
   systemd 249                             SYSTEMD-VOLATILE-ROOT.SERVICE(8)
