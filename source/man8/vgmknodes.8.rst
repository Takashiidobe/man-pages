...
::
          ...
          vgmknodes — Create the special files for volume group devices in
          /dev
...
::
          ...
          This command should not usually be needed if all the system
          components are interoperating correctly.
...
::
   ...
   Red Hat, Inc.       LVM TOOLS 2.03.13(2) (2021-08-11)       VGMKNODES(8)
