...
selinuxexeccon(8) — Linux manual page
=====================================
...
::
          ...
          selinuxexeccon reports the SELinux process context for the
          specified command from the specified context or the current
          context.
