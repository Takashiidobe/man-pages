...
mail.mboxfile(8) — Linux manual page
====================================
...
::
        ...
        mail.mboxfile appends mail to a file in mbox format and
        acknowledges delivery success or failure with its exit status.
...
::
        ...
        The mail.mboxfile utility exits 0 on success, and >0 if an error
        occurs.
