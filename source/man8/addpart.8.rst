...
::
          ...
          addpart tells the Linux kernel about the existence of the
...
::
          ...
          The addpart command is part of the util-linux package which can
   ...
   util-linux 2.37.85-637cc       2021-04-02                     ADDPART(8)

--------------

Pages that refer to this page: `delpart(8) <../man8/delpart.8.html>`__, 
