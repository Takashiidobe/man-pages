...
systemd-portabled.service(8) — Linux manual page
================================================
...
::
   ...
   SYSTEMD-PORTABLED.SERVICE(8)emd-portabled.serviceMD-PORTABLED.SERVICE(8)
...
::
          ...
          Most of systemd-portabled's functionality is accessible through
          the portablectl(1) command.

          See Portable Services[1] for details about the concepts this
          service implements.
...
::
   ...
   systemd 249                                 SYSTEMD-PORTABLED.SERVICE(8)
