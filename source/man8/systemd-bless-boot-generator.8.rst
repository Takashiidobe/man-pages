...
systemd-bless-boot-generator(8) — Linux manual page
===================================================
...
::
   ...
   SYSTEMD-BLESS-BOOT-GENERATOR(8)less-boot-generatorLESS-BOOT-GENERATOR(8)
...
::
          ...
          systemd-bless-boot-generator - Pull systemd-bless-boot.service
...
::
          ...
          systemd-bless-boot.service into the initial boot transaction when
          boot counting, as implemented by systemd-boot(7), is enabled.
...
::
   ...
   systemd 249                              SYSTEMD-BLESS-BOOT-GENERATOR(8)
