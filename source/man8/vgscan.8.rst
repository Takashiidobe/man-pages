...
::
          ...
          vgscan scans all supported LVM block devices in the system for
          VGs.
...
::
          ...
          --notifydbus
                 Send a notification to D-Bus. The command will exit with
                 an error if LVM is not built with support for D-Bus
                 notification, or if the notify_dbus config setting is
                 disabled.
...
::
   ...
   Red Hat, Inc.       LVM TOOLS 2.03.13(2) (2021-08-11)          VGSCAN(8)
