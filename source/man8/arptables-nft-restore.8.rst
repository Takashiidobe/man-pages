...
arptables-nft-restore(8) — Linux manual page
============================================
...
::
          ...
          arptables-restore is used to restore ARP Tables from data
          specified on STDIN or via a file as first argument.  Use I/O
