...
system-config-selinux(8) — Linux manual page
============================================
...
| \|                                |                                   |
| `LICENSE AND                      |                                   |
| AUTHORS <#LICENSE_AND_AUTHORS>`__ |                                   |
...
::
   ...
   system-config-selinux(8)ystem Config Tools Manualystem-config-selinux(8)
...
::
          ...
          system-config-selinux provides a graphical interface for managing
