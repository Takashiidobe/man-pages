...
::
          ...
          A PV cannot be removed from a VG while it is used by an active
          LV.

          Repeat the force option (-ff) to forcibly remove a PV belonging
          to an existing VG. Normally, vgreduce(8) should be used instead.
...
::
   ...
   Red Hat, Inc.       LVM TOOLS 2.03.13(2) (2021-08-11)        PVREMOVE(8)
