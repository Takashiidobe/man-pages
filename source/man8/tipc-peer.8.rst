...
::
          ...
          -h, --help
                 Show help about last valid command. For example tipc peer
                 --help will show peer help and tipc --help will show
...
::
      ...
      Peer remove
          Remove an offline peer node from the local data structures. The
          peer is identified by its address
...
::
          ...
          tipc-nametable(8), tipc-node(8), tipc-socket(8)
