...
systemd-importd.service(8) — Linux manual page
==============================================
...
::
   ...
   SYSTEMD-IMPORTD.SERVICE(8)ystemd-importd.serviceSTEMD-IMPORTD.SERVICE(8)
...
::
          ...
          exporting and downloading of system images suitable for running
          as VM or containers. It is a companion service for
          ...
          See org.freedesktop.import1(5) and org.freedesktop.LogControl1(5)
...
::
   ...
   systemd 249                                   SYSTEMD-IMPORTD.SERVICE(8)
