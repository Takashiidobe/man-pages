...
::
   ...
   SSH-SK-HELPER(8)       BSD System Manager's Manual      SSH-SK-HELPER(8)
...
::
        ...
        ssh-sk-helper is used by ssh-agent(1) to access keys provided by a
        FIDO authenticator.
        ...
        -v      Verbose mode.  Causes ssh-sk-helper to print debugging
                ...
                to ssh-sk-helper when it has itself been placed in debug
                mode.
