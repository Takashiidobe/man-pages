...
::
   ...
   SYSTEMD-HIBERNATE-RESUME@.SERVICE(8)e-resume@.service-RESUME@.SERVICE(8)
...
::
          ...
          implementation, known as swsusp[1]. Internally, it works by
...
::
   ...
   systemd 249                         SYSTEMD-HIBERNATE-RESUME@.SERVICE(8)
