...
sys_times.h(0p) — Linux manual page
===================================
...
::
          ...
          returned by times() and shall include at least the following
          members:
          ...
          The <sys/times.h> header shall define the clock_t type as
...
Pages that refer to this page: `times(1p) <../man1/times.1p.html>`__, 
