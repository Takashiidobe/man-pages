...
netinet_tcp.h(0p) — Linux manual page
=====================================
...
::
          ...
          The implementation need not allow the value of the option to be
          set via setsockopt() or retrieved via getsockopt().
...
::
          ...
          The System Interfaces volume of POSIX.1‐2017, getsockopt(3p),
          setsockopt(3p)
