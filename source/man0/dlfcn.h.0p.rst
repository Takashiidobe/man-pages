...
::
          ...
          constants for use in the construction of a dlopen() mode
          argument:

          RTLD_LAZY     Relocations are performed at an implementation-
                        defined time.

          RTLD_NOW      Relocations are performed when the object is
                        loaded.
...
::
          ...
          The System Interfaces volume of POSIX.1‐2017, dlclose(3p),
