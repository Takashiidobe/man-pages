...
babeltrace2-plugin-utils(7) — Linux manual page
===============================================
...
::
          ...
          babeltrace2-plugin-utils - Babeltrace 2's common graph utilities
          plugin
...
::
          ...
          filter.utils.trimmer
              Discards all the consumed messages with a time outside a
              given time range, effectively “cutting” trace streams.

              See babeltrace2-filter.utils.trimmer(7).

          sink.utils.counter
              Prints the number of consumed messages, either once at the
              end or periodically.
          ...
          sink.utils.dummy
              ...
              This is useful for testing and benchmarking a trace
              processing graph application, for example.
...
::
          ...
          babeltrace2-intro(7), babeltrace2-filter.utils.muxer(7),
