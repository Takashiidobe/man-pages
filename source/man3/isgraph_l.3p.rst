...
::
   ...
   ISGRAPH(3P)             POSIX Programmer's Manual            ISGRAPH(3P)
...
::
          ...
          For isgraph(): The functionality described on this reference page
          is aligned with the ISO C standard. Any conflict between the
          requirements described here and the ISO C standard is
          unintentional. This volume of POSIX.1‐2017 defers to the ISO C
          standard.

          The isgraph() and isgraph_l() functions shall test whether c is a
          character of class graph in the current locale, or in the locale
          ...
          The behavior is undefined if the locale argument to isgraph_l()
...
::
          ...
          The isgraph() and isgraph_l() functions shall return non-zero if
          c is a character with a visible representation; otherwise, they
          shall return 0.
...
::
   ...
   IEEE/The Open Group               2017                       ISGRAPH(3P)
