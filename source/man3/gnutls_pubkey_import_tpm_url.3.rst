...
gnutls_pubkey_import_tpm_url(3) — Linux manual page
===================================================
...
::
          ...
          int gnutls_pubkey_import_tpm_url(gnutls_pubkey_t pkey, const char
          * url, const char * srk_password, unsigned int flags);
...
::
   ...
   gnutls                            3.7.2  gnutls_pubkey_import_tpm_url(3)
