...
::
   ...
   gnutls_x509_trust_list_get_issuer(3)tlstls_x509_trust_list_get_issuer(3)
...
::
          ...
          list, gnutls_x509_crt_t cert, gnutls_x509_crt_t * issuer,
          unsigned int flags);
...
::
          ...
          unsigned int flags
                      ...
                      (GNUTLS_TL_GET_COPY is applicable)
...
::
          ...
          function to work with PKCS11 trust lists in a thread-safe way.
...
::
   ...
   gnutls                            3.7g.n2utls_x509_trust_list_get_issuer(3)
