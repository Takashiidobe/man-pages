...
pcap_set_datalink(3pcap) — Linux manual page
============================================
...
::
          ...
          pcap_set_datalink - set the link-layer header type to be used by
          a capture device
...
::
          ...
          pcap_set_datalink() is used to set the current link-layer header
          type of the pcap descriptor to the type specified by dlt.
