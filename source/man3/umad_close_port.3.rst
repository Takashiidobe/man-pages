...
umad_close_port(3) — Linux manual page
======================================
...
::
          ...
          umad_close_port() returns 0 on success, and a negative value on
          error.  -EINVAL is returned if the portid is not a handle to a
          valid (open) port.
...
::
   ...
   OpenIB                        May 11, 2007             UMAD_OPEN_PORT(3)
