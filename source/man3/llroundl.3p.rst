...
::
          ...
          These functions differ from the llrint() functions in that the
          default rounding direction for the llround() functions round
          halfway cases away from zero and need not raise the inexact
...
::
          ...
          feclearexcept(3p), fetestexcept(3p), lround(3p)
...
::
   ...
   IEEE/The Open Group               2017                       LLROUND(3P)
