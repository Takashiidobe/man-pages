...
::
          ...
          the menu will be made scrollable.  If this size is larger than
          the menus subwindow and the subwindow is too small to display all
          menu items, post_menu will fail.
          ...
          column argument to set_menu_format is interpreted as a request
