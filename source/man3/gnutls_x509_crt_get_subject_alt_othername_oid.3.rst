...
gnutls_x509_crt_get_subject_alt_othername_oid(3) — Linux manual page
====================================================================
...
::
   ...
   gnutls_x509_crt_get_subject_alt_othername_oid(3)ect_alt_othername_oid(3)
...
::
          ...
          int
          gnutls_x509_crt_get_subject_alt_othername_oid(gnutls_x509_crt_t
...
::
          ...
          void * oid  is the place where the otherName OID will be copied
                      to
...
::
   ...
   gnutls                  gnutls_x5039._7c.r2t_get_subject_alt_othername_oid(3)
