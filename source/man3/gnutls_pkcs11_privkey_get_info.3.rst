...
gnutls_pkcs11_privkey_get_info(3) — Linux manual page
=====================================================
...
::
   ...
   gnutls_pkcs11_privkey_get_info(3)gnutlsgnutls_pkcs11_privkey_get_info(3)
...
::
          ...
          size_t * output_size
                      contains the maximum size of the output and will be
...
::
   ...
   gnutls                            3.7.2gnutls_pkcs11_privkey_get_info(3)
