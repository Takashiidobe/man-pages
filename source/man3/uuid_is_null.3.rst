...
uuid_is_null(3) — Linux manual page
===================================
...
::
          ...
          UUID variable uu to the NULL value. If the value is equal to the
          NULL UUID, 1 is returned, otherwise 0 is returned.
...
::
   ...
   util-linux 2.37.85-637cc       2021-04-02                UUID_IS_NULL(3)
