...
::
          ...
          occur and exp2(), exp2f(), and exp2l() shall return the value of
          the macro HUGE_VAL, HUGE_VALF, and HUGE_VALL, respectively.

          If the correct value would cause underflow, and is not
          representable, a range error may occur, and exp2(), exp2f(), and
          exp2l() shall return 0.0, or (if the IEC 60559 Floating-Point
...
::
          ...
          exp(3p), feclearexcept(3p), fetestexcept(3p), isnan(3p), log(3p)
...
::
   ...
   IEEE/The Open Group               2017                          EXP2(3P)
