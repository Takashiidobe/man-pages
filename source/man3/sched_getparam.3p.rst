...
sched_getparam(3p) — Linux manual page
======================================
...
::
          ...
          shall be returned. The behavior of the sched_getparam() function
          is unspecified if the value of pid is negative.
...
::
          ...
          return zero. If the call to sched_getparam() is unsuccessful, the
...
::
          ...
          EPERM  The requesting process does not have permission to obtain
                 the scheduling parameters of the specified process.
...
::
          ...
          sched_getscheduler(3p), sched_setparam(3p),
