...
pcap_dump_flush(3pcap) — Linux manual page
==========================================
...
::
          ...
          pcap_dump_flush() flushes the output buffer to the ``savefile,''
          so that any packets written with pcap_dump(3PCAP) but not yet
          written to the ``savefile'' will be written.
