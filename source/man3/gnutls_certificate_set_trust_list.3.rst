...
gnutls_certificate_set_trust_list(3) — Linux manual page
========================================================
...
::
   ...
   gnutls_certificate_set_trust_list(3)tlstls_certificate_set_trust_list(3)
...
::
          ...
          void
          gnutls_certificate_set_trust_list(gnutls_certificate_credentials_t
          res, gnutls_x509_trust_list_t tlist, unsigned flags);
...
::
   ...
   gnutls                            3.7g.n2utls_certificate_set_trust_list(3)
