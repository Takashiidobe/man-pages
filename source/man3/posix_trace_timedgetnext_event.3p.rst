...
posix_trace_timedgetnext_event(3p) — Linux manual page
======================================================
...
::
   ...
   POSIX_TRACE_TIMEDGETNEXT_EVENT(3P)rammer'sXManual_TIMEDGETNEXT_EVENT(3P)
...
::
          ...
          Refer to posix_trace_getnext_event(3p).
...
::
   ...
   IEEE/The Open Group               2017POSIX_TRACE_TIMEDGETNEXT_EVENT(3P)
