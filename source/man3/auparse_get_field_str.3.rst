...
auparse_get_field_str(3) — Linux manual page
============================================
...
::
          ...
          auparse_get_field_str allows access to the value in the current
...
::
   ...
   Red Hat                         Feb 2007        AUPARSE_GET_FIELD_STR(3)

--------------

Pages that refer to this page:
`auparse_get_field_int(3) <../man3/auparse_get_field_int.3.html>`__, 
