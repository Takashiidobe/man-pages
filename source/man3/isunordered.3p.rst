...
isunordered(3p) — Linux manual page
===================================
...
::
   ...
   ISUNORDERED(3P)         POSIX Programmer's Manual        ISUNORDERED(3P)
...
::
          ...
          Upon successful completion, the isunordered() macro shall return
...
::
   ...
   IEEE/The Open Group               2017                   ISUNORDERED(3P)
