...
gnutls_x509_crl_get_issuer_dn(3) — Linux manual page
====================================================
...
::
          ...
          int gnutls_x509_crl_get_issuer_dn(gnutls_x509_crl_t crl, char *
...
::
          ...
          This function will copy the name of the CRL issuer in the
          ...
          if that is required see gnutls_x509_crl_get_issuer_dn3().
...
::
   ...
   gnutls                            3.7.2 gnutls_x509_crl_get_issuer_dn(3)
