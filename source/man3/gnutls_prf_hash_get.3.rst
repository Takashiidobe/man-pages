...
gnutls_prf_hash_get(3) — Linux manual page
==========================================
...
::
   ...
   gnutls_prf_hash_get(3)           gnutls           gnutls_prf_hash_get(3)
...
::
          ...
          gnutls_digest_algorithm_t gnutls_prf_hash_get(const
...
::
          ...
          the currently used hash algorithm, a gnutls_digest_algorithm_t
          value.
...
::
   ...
   gnutls                            3.7.2           gnutls_prf_hash_get(3)
