...
::
   ...
   gnutls_sign_get_pk_algorithm(3)  gnutls  gnutls_sign_get_pk_algorithm(3)
...
::
          ...
          when dealing with such algorithms use instead
...
::
          ...
          return a gnutls_pk_algorithm_t value, or GNUTLS_PK_UNKNOWN on
          error.
...
::
   ...
   gnutls                            3.7.2  gnutls_sign_get_pk_algorithm(3)
