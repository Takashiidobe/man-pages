...
libpfm_intel_snbep_unc_qpi(3) — Linux manual page
=================================================
...
::
          ...
          libpfm_intel_snbep_unc_qpi - support for Intel Sandy Bridge-EP
          QPI uncore PMU
...
::
          ...
          PMU name: snbep_unc_qpi0, snbep_unc_qpi1
          PMU desc: Intel Sandy Bridge-EP QPI uncore PMU
...
::
          ...
          The following modifiers are supported on Intel Sandy Bridge QPI
          uncore PMU:

          i      Invert the meaning of the event. The counter will now
                 count QPI cycles in which the event is not occurring. This
