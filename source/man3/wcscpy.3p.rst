...
::
          ...
          wcpcpy, wcscpy — copy a wide-character string, returning a
          pointer to its end
...
::
          ...
          For wcscpy(): The functionality described on this reference page
          ...
          wcslen(ws2)+1 wide characters in the ws1 array, and that the ws2
          and ws1 arrays do not overlap.
...
::
          ...
          The wcpcpy() function shall return a pointer to the terminating
          null wide-character code copied into the ws1 buffer.
...
`wcpcpy(3p) <../man3/wcpcpy.3p.html>`__, 
