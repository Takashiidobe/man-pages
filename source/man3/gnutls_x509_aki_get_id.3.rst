...
gnutls_x509_aki_get_id(3) — Linux manual page
=============================================
...
::
   ...
   gnutls_x509_aki_get_id(3)        gnutls        gnutls_x509_aki_get_id(3)
...
::
          ...
          int gnutls_x509_aki_get_id(gnutls_x509_aki_t aki, gnutls_datum_t
          * id);
...
::
          ...
          aki type. The identifier should be treated as constant.
...
::
   ...
   gnutls                            3.7.2        gnutls_x509_aki_get_id(3)
