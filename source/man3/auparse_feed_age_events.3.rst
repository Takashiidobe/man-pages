...
auparse_feed_age_events(3) — Linux manual page
==============================================
...
::
   ...
   AUPARSE_FEED_AGE_EVENTS(3)   Linux Audit API  AUPARSE_FEED_AGE_EVENTS(3)
...
::
          ...
          auparse_feed_age_events - check events for complete based on
          time.
...
::
          ...
          complete based on the current clock time. Any newly complete
          events will be passed to the callback function.
...
::
   ...
   Red Hat                         Apr 2016      AUPARSE_FEED_AGE_EVENTS(3)
