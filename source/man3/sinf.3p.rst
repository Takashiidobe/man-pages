...
::
          ...
          These functions shall compute the sine of their argument x,
          measured in radians.
...
::
          ...
          multiple of π or is far from 0.0.
...
::
          ...
          asin(3p), feclearexcept(3p), fetestexcept(3p), isnan(3p)
...
`cos(3p) <../man3/cos.3p.html>`__,  `sinl(3p) <../man3/sinl.3p.html>`__
