...
gnutls_x509_trust_list_add_system_trust(3) — Linux manual page
==============================================================
...
::
   ...
   gnutls_x509_trust_list_add_system_trust(3)trust_list_add_system_trust(3)
...
::
          ...
          list, unsigned int tl_flags, unsigned int tl_vflags);
...
::
   ...
   gnutls                        gnut3l.s7_.x2509_trust_list_add_system_trust(3)
