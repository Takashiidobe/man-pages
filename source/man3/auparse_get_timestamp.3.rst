...
auparse_get_timestamp(3) — Linux manual page
============================================
...
::
          ...
          Returns NULL if an error occurs; otherwise, a valid pointer to
          the data.
...
`auparse_node_compare(3) <../man3/auparse_node_compare.3.html>`__, 
`auparse_timestamp_compare(3) <../man3/auparse_timestamp_compare.3.html>`__
