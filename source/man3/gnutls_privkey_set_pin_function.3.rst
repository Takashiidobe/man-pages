...
gnutls_privkey_set_pin_function(3) — Linux manual page
======================================================
...
::
   ...
   gnutls_privkey_set_pin_function(3)nutlsnutls_privkey_set_pin_function(3)
...
::
   ...
   gnutls                            3.7.2gnutls_privkey_set_pin_function(3)
