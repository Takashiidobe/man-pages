...
gnutls_pcert_import_rawpk_raw(3) — Linux manual page
====================================================
...
::
          ...
          int gnutls_pcert_import_rawpk_raw(gnutls_pcert_st* pcert, const
          gnutls_datum_t* rawpubkey, gnutls_x509_crt_fmt_t format, unsigned
...
::
          ...
          const gnutls_datum_t* rawpubkey
                      The raw public-key in gnutls_datum_t format to be
                      imported.
...
::
          ...
          This convenience function will import (i.e. convert) the given
          raw public key  rawpubkey into a gnutls_pcert_st structure. The
...
::
   ...
   gnutls                            3.7.2 gnutls_pcert_import_rawpk_raw(3)
