...
libpfm_intel_skx_unc_imc(3) — Linux manual page
===============================================
...
::
          ...
          libpfm_intel_skx_unc_imc - support for Intel Skylake X Server
...
::
          ...
          PMU name: skx_unc_imc[0-7]
          PMU desc: Intel Skylake X Server IMC uncore PMU
...
::
          ...
          The library supports the Intel Skylake X Server Integrated Memory
          Controller (IMC) uncore PMU.
