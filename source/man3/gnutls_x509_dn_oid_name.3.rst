...
gnutls_x509_dn_oid_name(3) — Linux manual page
==============================================
...
::
   ...
   gnutls_x509_dn_oid_name(3)       gnutls       gnutls_x509_dn_oid_name(3)
...
::
          ...
          const char * gnutls_x509_dn_oid_name(const char * oid, unsigned
          int flags);
...
::
   ...
   gnutls                            3.7.2       gnutls_x509_dn_oid_name(3)
