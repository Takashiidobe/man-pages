...
::
   ...
   gnutls_ocsp_resp_verify_direct(3)gnutlsgnutls_ocsp_resp_verify_direct(3)
...
::
          ...
          gnutls_x509_crt_t issuer, unsigned int * verify, unsigned int
          flags);
...
::
   ...
   gnutls                            3.7.2gnutls_ocsp_resp_verify_direct(3)
