...
gnutls_x509_crl_dist_points_get(3) — Linux manual page
======================================================
...
::
   ...
   gnutls_x509_crl_dist_points_get(3)nutlsnutls_x509_crl_dist_points_get(3)
...
::
          ...
          cdp, unsigned int seq, unsigned int * type, gnutls_datum_t * san,
...
::
          ...
          unsigned int seq
                      specifies the sequence number of the distribution
                      point (0 for the first one, 1 for the second etc.)

          unsigned int * type
                      The name type of the corresponding name
                      (gnutls_x509_subject_alt_name_t)

          gnutls_datum_t * san
                      The distribution point names (to be treated as
                      constant)
...
::
   ...
   gnutls                            3.7.2gnutls_x509_crl_dist_points_get(3)
