...
gnutls_x509_crq_get_extension_data2(3) — Linux manual page
==========================================================
...
::
   ...
   gnutls_x509_crq_get_extension_data2(3)ss_x509_crq_get_extension_data2(3)
...
::
          ...
          unsigned indx
                      Specifies which extension OID to read. Use (0) to get
                      the first one.
...
::
   ...
   gnutls                            3g.n7u.t2ls_x509_crq_get_extension_data2(3)
