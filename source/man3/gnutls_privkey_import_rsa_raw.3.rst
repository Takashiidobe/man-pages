...
gnutls_privkey_import_rsa_raw(3) — Linux manual page
====================================================
...
::
          ...
          int gnutls_privkey_import_rsa_raw(gnutls_privkey_t key, const
          gnutls_datum_t * m, const gnutls_datum_t * e, const
...
::
   ...
   gnutls                            3.7.2 gnutls_privkey_import_rsa_raw(3)
