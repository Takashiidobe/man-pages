...
::
          ...
          iswupper, iswupper_l — test for an uppercase letter wide-
          character code
...
::
          ...
          For iswupper(): The functionality described on this reference
          page is aligned with the ISO C standard. Any conflict between the
          requirements described here and the ISO C standard is
          unintentional. This volume of POSIX.1‐2017 defers to the ISO C
          standard.

          The iswupper() and iswupper_l() functions shall test whether wc
          is a wide-character code representing a character of class upper
          ...
          The behavior is undefined if the locale argument to iswupper_l()
...
::
          ...
          The iswupper() and iswupper_l() functions shall return non-zero
          if wc is an uppercase letter wide-character code; otherwise, they
          shall return 0.
...
::
          ...
          iswpunct(3p), iswspace(3p), iswxdigit(3p), setlocale(3p),
          uselocale(3p)
