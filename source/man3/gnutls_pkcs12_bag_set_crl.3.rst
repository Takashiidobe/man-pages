...
gnutls_pkcs12_bag_set_crl(3) — Linux manual page
================================================
...
::
          ...
          This function will insert the given CRL into the bag. This is
          just a wrapper over gnutls_pkcs12_bag_set_data().
...
::
   ...
   gnutls                            3.7.2     gnutls_pkcs12_bag_set_crl(3)
