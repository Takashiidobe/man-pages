...
gnutls_x509_crl_list_import(3) — Linux manual page
==================================================
...
::
   ...
   gnutls_x509_crl_list_import(3)   gnutls   gnutls_x509_crl_list_import(3)
...
::
          ...
          gnutls_x509_crl_t * crls
                      Indicates where the parsed CRLs will be copied to.
                      Must not be initialized.

          unsigned int * crl_max
                      Initially must hold the maximum number of crls. It
                      will be updated with the number of crls available.
...
::
   ...
   gnutls                            3.7.2   gnutls_x509_crl_list_import(3)
