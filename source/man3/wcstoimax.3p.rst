...
wcstoimax(3p) — Linux manual page
=================================
...
::
          ...
          wcstoimax, wcstoumax — convert a wide-character string to an
          integer type
...
::
          ...
          wcstoul(), and wcstoull() functions, respectively, except that
          the initial portion of the wide string shall be converted to
...
::
          ...
          If no conversion could be performed, zero shall be returned. If
...
`wcstoumax(3p) <../man3/wcstoumax.3p.html>`__
