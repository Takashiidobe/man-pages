...
gnutls_srp_base64_decode2(3) — Linux manual page
================================================
...
::
          ...
          data will be allocated, and stored into result.  It will decode
          using the base64 algorithm as used in libsrp.
...
::
   ...
   gnutls                            3.7.2     gnutls_srp_base64_decode2(3)
