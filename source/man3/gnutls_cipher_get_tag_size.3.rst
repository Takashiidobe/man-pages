...
gnutls_cipher_get_tag_size(3) — Linux manual page
=================================================
...
::
   ...
   gnutls_cipher_get_tag_size(3)    gnutls    gnutls_cipher_get_tag_size(3)
...
::
          ...
          unsigned gnutls_cipher_get_tag_size(gnutls_cipher_algorithm_t
          algorithm);
...
::
   ...
   gnutls                            3.7.2    gnutls_cipher_get_tag_size(3)
