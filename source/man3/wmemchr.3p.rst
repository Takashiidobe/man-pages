...
::
          ...
          the initial n wide characters of the object pointed to by ws.
          ...
          pointer and the function behaves as if no valid occurrence of wc
          is found.
...
::
          ...
          wmemcmp(3p), wmemcpy(3p), wmemmove(3p), wmemset(3p)
