...
libpfm_intel_snbep_unc_r3qpi(3) — Linux manual page
===================================================
...
::
          ...
          libpfm_intel_snbep_unc_r3qpi - support for Intel Sandy Bridge-EP
          R3QPI uncore PMU
...
::
          ...
          PMU name: snbep_unc_r3qpi0, snbep_unc_r3qpi0
          PMU desc: Intel Sandy Bridge-EP R3QPI uncore PMU
...
::
          ...
          The following modifiers are supported on Intel Sandy Bridge R3PQI
          uncore PMU:

          i      Invert the meaning of the event. The counter will now
                 count R3QPI cycles in which the event is not occurring.
