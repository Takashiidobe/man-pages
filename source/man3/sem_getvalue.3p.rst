...
sem_getvalue(3p) — Linux manual page
====================================
...
::
          ...
          If sem is locked, then the object to which sval points shall
          either be set to zero or to a negative number whose absolute
...
::
          ...
          sem_timedwait(3p), sem_trywait(3p)
