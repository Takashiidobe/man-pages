...
gnutls_x509_crq_get_key_rsa_raw(3) — Linux manual page
======================================================
...
::
   ...
   gnutls_x509_crq_get_key_rsa_raw(3)nutlsnutls_x509_crq_get_key_rsa_raw(3)
...
::
          ...
          This function will export the RSA public key's parameters found
...
::
   ...
   gnutls                            3.7.2gnutls_x509_crq_get_key_rsa_raw(3)
