...
gnutls_privkey_import_openpgp_raw(3) — Linux manual page
========================================================
...
::
   ...
   gnutls_privkey_import_openpgp_raw(3)tlstls_privkey_import_openpgp_raw(3)
...
::
   ...
   gnutls                            3.7g.n2utls_privkey_import_openpgp_raw(3)
