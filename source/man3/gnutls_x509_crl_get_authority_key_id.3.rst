...
gnutls_x509_crl_get_authority_key_id(3) — Linux manual page
===========================================================
...
::
   ...
   gnutls_x509_crl_get_authority_key_id(3)_x509_crl_get_authority_key_id(3)
...
::
          ...
          void * id, size_t * id_size, unsigned int * critical);
...
::
          ...
          field (2.5.29.35).  Note that this function only returns the
...
::
   ...
   gnutls                           g3n.u7t.l2s_x509_crl_get_authority_key_id(3)
