...
auparse_feed_has_data(3) — Linux manual page
============================================
...
::
   ...
   AUPARSE_FEED_HAS_DATA(3)     Linux Audit API    AUPARSE_FEED_HAS_DATA(3)
...
::
          ...
          auparse_feed_has_data - check if there is any data accumulating
          that might need flushing.
...
::
   ...
   Red Hat                         Apr 2016        AUPARSE_FEED_HAS_DATA(3)
