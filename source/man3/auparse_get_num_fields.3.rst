...
auparse_get_num_fields(3) — Linux manual page
=============================================
...
::
   ...
   AUPARSE_GET_NUM_FIELDS(3)    Linux Audit API   AUPARSE_GET_NUM_FIELDS(3)
...
::
          ...
          auparse_get_num_fields gets the number of fields in the current
          record of the current event.
