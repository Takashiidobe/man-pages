...
gnutls_privkey_sign_data(3) — Linux manual page
===============================================
...
::
          ...
          functions may be used for the RSA algorithm, but only the SHA
          family for the DSA keys.
...
::
   ...
   gnutls                            3.7.2      gnutls_privkey_sign_data(3)
