...
gnutls_certificate_free_keys(3) — Linux manual page
===================================================
...
::
   ...
   gnutls_certificate_free_keys(3)  gnutls  gnutls_certificate_free_keys(3)
...
::
          ...
          void
          gnutls_certificate_free_keys(gnutls_certificate_credentials_t
          sc);
...
::
   ...
   gnutls                            3.7.2  gnutls_certificate_free_keys(3)
