...
gnutls_pkcs11_token_check_mechanism(3) — Linux manual page
==========================================================
...
::
   ...
   gnutls_pkcs11_token_check_mechanism(3)ss_pkcs11_token_check_mechanism(3)
...
::
          ...
          unsigned long mechanism, void * ptr, unsigned psize, unsigned
          flags);
...
::
          ...
          given token. If the mechanism is supported and
...
::
   ...
   gnutls                            3g.n7u.t2ls_pkcs11_token_check_mechanism(3)
