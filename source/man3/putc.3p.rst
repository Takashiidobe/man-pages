...
::
          ...
          The putc() function shall be equivalent to fputc(), except that
...
::
          ...
          Since it may be implemented as a macro, putc() may treat a stream
          argument with side-effects incorrectly. In particular,
          putc(c,*f++) does not necessarily work correctly.  Therefore, use
          of this function is not recommended in such situations; fputc()
...
::
          ...
          Section 2.5, Standard I/O Streams, fputc(3p)
...
::
   ...
   IEEE/The Open Group               2017                          PUTC(3P)
