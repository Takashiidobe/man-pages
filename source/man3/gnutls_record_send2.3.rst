...
gnutls_record_send2(3) — Linux manual page
==========================================
...
::
          ...
          ssize_t gnutls_record_send2(gnutls_session_t session, const void
          * data, size_t data_size, size_t pad, unsigned flags);
...
::
          ...
          takes an extra argument to specify padding to be added the
          record.  To determine the maximum size of padding, use
...
::
   ...
   gnutls                            3.7.2           gnutls_record_send2(3)
