...
sd_bus_message_append_strv(3) — Linux manual page
=================================================
...
::
   ...
   SD_BUS_MESSAGE_APPEND_STRV(3)_message_append_strv_MESSAGE_APPEND_STRV(3)
...
::
   ...
   systemd 249                                SD_BUS_MESSAGE_APPEND_STRV(3)
