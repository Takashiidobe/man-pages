...
gnutls_x509_crq_get_dn_by_oid(3) — Linux manual page
====================================================
...
::
          ...
          int gnutls_x509_crq_get_dn_by_oid(gnutls_x509_crq_t crq, const
...
::
          ...
          in RFC2253 -- in hex format with a 'using
...
::
   ...
   gnutls                            3.7.2 gnutls_x509_crq_get_dn_by_oid(3)
