...
pthread_getcpuclockid(3p) — Linux manual page
=============================================
...
::
   ...
   PTHREAD_GETCPUCLOCKID(3P)OSIX Programmer's ManualHREAD_GETCPUCLOCKID(3P)
...
::
          ...
          clock ID of the CPU-time clock of the thread specified by
          thread_id, if the thread specified by thread_id exists.
...
::
          ...
          Upon successful completion, pthread_getcpuclockid() shall return
...
::
          ...
          The pthread_getcpuclockid() function is part of the Thread CPU-
