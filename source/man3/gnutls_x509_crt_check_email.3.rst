...
gnutls_x509_crt_check_email(3) — Linux manual page
==================================================
...
::
   ...
   gnutls_x509_crt_check_email(3)   gnutls   gnutls_x509_crt_check_email(3)
...
::
          ...
          const char * email
                      A null terminated string that contains an email
                      address (RFC822)
...
::
   ...
   gnutls                            3.7.2   gnutls_x509_crt_check_email(3)
