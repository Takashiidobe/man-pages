...
gnutls_dh_params_export_pkcs3(3) — Linux manual page
====================================================
...
::
   ...
   gnutls_dh_params_export_pkcs3(3) gnutls gnutls_dh_params_export_pkcs3(3)
...
::
          ...
          unsigned char * params_data
                      will contain a PKCS3 DHParams structure PEM or DER
                      encoded

          size_t * params_data_size
                      holds the size of params_data (and will be replaced
...
::
   ...
   gnutls                            3.7.2 gnutls_dh_params_export_pkcs3(3)
