...
gnutls_utf8_password_normalize(3) — Linux manual page
=====================================================
...
::
   ...
   gnutls_utf8_password_normalize(3)gnutlsgnutls_utf8_password_normalize(3)
...
::
          ...
          int gnutls_utf8_password_normalize(const unsigned char *
...
::
          ...
          GNUTLS_E_INVALID_UTF8_STRING on invalid UTF-8 data, or 0 on
          success.
...
::
   ...
   gnutls                            3.7.2gnutls_utf8_password_normalize(3)
