...
::
          ...
          size_t * data_length
                      will hold the data length. Must hold the maximum size
                      of data.
...
::
          ...
          On success, GNUTLS_E_SUCCESS (0) is returned, on UTF-8 decoding
          error GNUTLS_E_IDNA_ERROR is returned, otherwise a negative error
          code is returned.
...
::
   ...
   gnutls                            3.7.2        gnutls_server_name_get(3)
