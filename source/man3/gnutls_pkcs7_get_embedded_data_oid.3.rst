...
gnutls_pkcs7_get_embedded_data_oid(3) — Linux manual page
=========================================================
...
::
   ...
   gnutls_pkcs7_get_embedded_data_oid(3)lsls_pkcs7_get_embedded_data_oid(3)
...
::
          ...
          const char * gnutls_pkcs7_get_embedded_data_oid(gnutls_pkcs7_t
          pkcs7);
...
::
          ...
          On success, a pointer to an OID string, NULL on error.
...
::
   ...
   gnutls                            3.g7n.u2tls_pkcs7_get_embedded_data_oid(3)
