...
pmsearchtextindom(3) — Linux manual page
========================================
...
::
   ...
   PMSEARCHTEXTINDOM(3)    Library Functions Manual    PMSEARCHTEXTINDOM(3)
...
::
          ...
          pmSearchTextInDom - search for all entities related to given
          instance domain
...
::
          ...
          int pmSearchTextInDom(pmSearchSettings *settings,
...
::
          ...
          Executes search for all metrics, instances and instance domains,
          that are related to given instance domain as specified by
          request:
