...
::
   ...
   ISXDIGIT(3P)            POSIX Programmer's Manual           ISXDIGIT(3P)
...
::
          ...
          For isxdigit(): The functionality described on this reference
          page is aligned with the ISO C standard. Any conflict between the
          requirements described here and the ISO C standard is
          unintentional. This volume of POSIX.1‐2017 defers to the ISO C
          standard.

          The isxdigit() and isxdigit_l() functions shall test whether c is
          a character of class xdigit in the current locale, or in the
          locale represented by locale, respectively; see the Base
          ...
          The behavior is undefined if the locale argument to isxdigit_l()
...
::
          ...
          The isxdigit() and isxdigit_l() functions shall return non-zero
          if c is a hexadecimal digit; otherwise, they shall return 0.
...
::
          ...
          isgraph(3p), islower(3p), isprint(3p), ispunct(3p), isspace(3p),
          isupper(3p)
...
::
   ...
   IEEE/The Open Group               2017                      ISXDIGIT(3P)
