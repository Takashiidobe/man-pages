...
gnutls_cipher_get_key_size(3) — Linux manual page
=================================================
...
::
   ...
   gnutls_cipher_get_key_size(3)    gnutls    gnutls_cipher_get_key_size(3)
...
::
   ...
   gnutls                            3.7.2    gnutls_cipher_get_key_size(3)
