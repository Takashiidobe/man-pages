...
gnutls_privkey_import_tpm_raw(3) — Linux manual page
====================================================
...
::
          ...
          int gnutls_privkey_import_tpm_raw(gnutls_privkey_t pkey, const
...
::
   ...
   gnutls                            3.7.2 gnutls_privkey_import_tpm_raw(3)
