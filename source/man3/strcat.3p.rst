...
::
          ...
          to by s2 (including the terminating NUL character) to the end of
          the string pointed to by s1.  The initial byte of s2 overwrites
          the NUL character at the end of s1.  If copying takes place
...
::
          ...
          The strcat() function shall return s1; no return value is
...
::
   ...
   IEEE/The Open Group               2017                        STRCAT(3P)
