...
gnutls_priority_ecc_curve_list(3) — Linux manual page
=====================================================
...
::
   ...
   gnutls_priority_ecc_curve_list(3)gnutlsgnutls_priority_ecc_curve_list(3)
...
::
          ...
          This function has been replaced by gnutls_priority_group_list()
          since 3.6.0.
...
::
   ...
   gnutls                            3.7.2gnutls_priority_ecc_curve_list(3)
