...
gnutls_hkdf_expand(3) — Linux manual page
=========================================
...
::
          ...
          int gnutls_hkdf_expand(gnutls_mac_algorithm_t mac, const
          gnutls_datum_t * key, const gnutls_datum_t * info, void * output,
          size_t length);
...
::
   ...
   gnutls                            3.7.2            gnutls_hkdf_expand(3)
