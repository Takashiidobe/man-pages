...
gnutls_x509_tlsfeatures_check_crt(3) — Linux manual page
========================================================
...
::
   ...
   gnutls_x509_tlsfeatures_check_crt(3)tlstls_x509_tlsfeatures_check_crt(3)
...
::
          ...
          non-zero if the provided certificate complies, and zero
          otherwise.
...
::
   ...
   gnutls                            3.7g.n2utls_x509_tlsfeatures_check_crt(3)
