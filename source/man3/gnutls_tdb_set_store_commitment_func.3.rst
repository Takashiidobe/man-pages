...
gnutls_tdb_set_store_commitment_func(3) — Linux manual page
===========================================================
...
::
   ...
   gnutls_tdb_set_store_commitment_func(3)_tdb_set_store_commitment_func(3)
...
::
          ...
          with the trust storage structure. The function is of the
          following form.
...
::
   ...
   gnutls                           g3n.u7t.l2s_tdb_set_store_commitment_func(3)
