...
gnutls_pkcs11_token_get_mechanism(3) — Linux manual page
========================================================
...
::
   ...
   gnutls_pkcs11_token_get_mechanism(3)tlstls_pkcs11_token_get_mechanism(3)
...
::
          ...
          int gnutls_pkcs11_token_get_mechanism(const char * url, unsigned
...
::
   ...
   gnutls                            3.7g.n2utls_pkcs11_token_get_mechanism(3)
