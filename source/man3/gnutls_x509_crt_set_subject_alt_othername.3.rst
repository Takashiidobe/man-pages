...
gnutls_x509_crt_set_subject_alt_othername(3) — Linux manual page
================================================================
...
::
   ...
   gnutls_x509_crt_set_subject_alt_othername(3)set_subject_alt_othername(3)
...
::
          ...
          int gnutls_x509_crt_set_subject_alt_othername(gnutls_x509_crt_t
          crt, const char * oid, const void * data, unsigned int data_size,
          unsigned int flags);
...
::
   ...
   gnutls                      gnutls3_.x75.029_crt_set_subject_alt_othername(3)
