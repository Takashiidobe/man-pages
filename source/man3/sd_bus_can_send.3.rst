...
sd_bus_can_send(3) — Linux manual page
======================================
...
::
          ...
          On failure, sd_bus_can_send() returns a negative errno-style
          error code. If values of the given type can be sent over the
          given bus, it returns a positive integer. Otherwise, it returns
          zero.
