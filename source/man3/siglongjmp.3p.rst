...
siglongjmp(3p) — Linux manual page
==================================
...
::
   ...
   SIGLONGJMP(3P)          POSIX Programmer's Manual         SIGLONGJMP(3P)
...
::
          ...
          returned the value specified by val.  The siglongjmp() function
          shall not cause sigsetjmp() to return 0; if val is 0, sigsetjmp()
...
::
          ...
          longjmp(3p), pthread_sigmask(3p), setjmp(3p), sigsetjmp(3p),
          sigsuspend(3p)
...
::
   ...
   IEEE/The Open Group               2017                    SIGLONGJMP(3P)
