...
gnutls_pcert_import_openpgp_raw(3) — Linux manual page
======================================================
...
::
   ...
   gnutls_pcert_import_openpgp_raw(3)nutlsnutls_pcert_import_openpgp_raw(3)
...
::
          ...
          const gnutls_datum_t * cert, gnutls_openpgp_crt_fmt_t
...
::
   ...
   gnutls                            3.7.2gnutls_pcert_import_openpgp_raw(3)
