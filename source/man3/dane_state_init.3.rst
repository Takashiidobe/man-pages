...
dane_state_init(3) — Linux manual page
======================================
...
::
          ...
          intended to be used in scenarios where multiple resolvings occur,
          to optimize against multiple re-initializations.
...
::
   ...
   gnutls                            3.7.2               dane_state_init(3)
