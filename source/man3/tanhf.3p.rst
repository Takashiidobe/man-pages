...
::
          ...
          These functions shall compute the hyperbolic tangent of their
          argument x.
...
::
          ...
          If x is not returned, tanh(), tanhf(), and tanhl() shall return
...
::
          ...
          atanh(3p), feclearexcept(3p), fetestexcept(3p), isnan(3p),
          tan(3p)
