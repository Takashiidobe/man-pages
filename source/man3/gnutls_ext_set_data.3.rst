...
gnutls_ext_set_data(3) — Linux manual page
==========================================
...
::
   ...
   gnutls_ext_set_data(3)           gnutls           gnutls_ext_set_data(3)
...
::
          ...
          void gnutls_ext_set_data(gnutls_session_t session, unsigned
          tls_id, gnutls_ext_priv_data_t data);
...
::
   ...
   gnutls                            3.7.2           gnutls_ext_set_data(3)
