...
::
          ...
          These functions shall compute the hyperbolic cosine of their
          argument x.
...
::
          ...
          occur and cosh(), coshf(), and coshl() shall return the value of
...
::
          ...
          acosh(3p), feclearexcept(3p), fetestexcept(3p), isnan(3p),
          sinh(3p), tanh(3p)
...
::
   ...
   IEEE/The Open Group               2017                          COSH(3P)
