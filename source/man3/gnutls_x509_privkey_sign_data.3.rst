...
gnutls_x509_privkey_sign_data(3) — Linux manual page
====================================================
...
::
          ...
          gnutls_datum_t * data, void * signature, size_t *
          signature_size);
...
::
          ...
          size_t * signature_size
                      holds the size of signature (and will be replaced by
                      the new size)
...
::
          ...
          This function will sign the given data using a signature
          algorithm supported by the private key. Signature algorithms are
          always used together with a hash functions.  Different hash
          functions may be used for the RSA algorithm, but only SHA-1 for
          the DSA keys.

          If the buffer provided is not long enough to hold the output,
          then * signature_size is updated and GNUTLS_E_SHORT_MEMORY_BUFFER
          will be returned.
...
::
   ...
   gnutls                            3.7.2 gnutls_x509_privkey_sign_data(3)
