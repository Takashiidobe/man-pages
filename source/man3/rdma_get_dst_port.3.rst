...
rdma_get_dst_port(3) — Linux manual page
========================================
...
::
          ...
          Returns the remote port number for an rdma_cm_id that has been
          bound to a remote address.
...
::
          ...
          Returns the 16-bit port identifier associated with the peer
          endpoint.  If the rdma_cm_id is not connected, the returned value
          is 0.
...
::
          ...
          rdma_get_src_port(3), rdma_get_local_addr(3),
