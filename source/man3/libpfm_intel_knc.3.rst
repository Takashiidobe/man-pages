...
libpfm_intel_knc(3) — Linux manual page
=======================================
...
::
          ...
          The following modifiers are supported on Intel Knights Corner
          processors:
          ...
          t      Measure on all threads at the same time assuming hyper-
