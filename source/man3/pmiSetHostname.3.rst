...
pmisethostname(3) — Linux manual page
=====================================
...
::
          ...
          LOGIMPORT(3)), pmiSetHostname sets the source hostname in the
          current context to be value.

          In the absence of a call to pmiSetHostname the source hostname
          defaults to the hostname of the localhost.
...
::
          ...
          pmiSetHostname returns zero on success else a negative value that
