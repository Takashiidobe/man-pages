...
gnutls_hmac_fast(3) — Linux manual page
=======================================
...
::
          ...
          int gnutls_hmac_fast(gnutls_mac_algorithm_t algorithm, const void
          * key, size_t keylen, const void * ptext, size_t ptext_len, void
          * digest);
...
::
   ...
   gnutls                            3.7.2              gnutls_hmac_fast(3)
