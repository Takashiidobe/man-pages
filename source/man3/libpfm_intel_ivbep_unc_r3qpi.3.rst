...
libpfm_intel_ivbep_unc_r3qpi(3) — Linux manual page
===================================================
...
::
          ...
          libpfm_intel_ivbep_unc_r3qpi - support for Intel Ivy Bridge-EP
          R3QPI uncore PMU
...
::
          ...
          PMU name: ivbep_unc_r3qpi0, ivbep_unc_r3qpi1, ivbep_unc_r3qpi2
          PMU desc: Intel Ivy Bridge-EP R3QPI uncore PMU
...
::
          ...
          The library supports the Intel Ivy Bridge R3QPI uncore PMU.  This
          PMU model only exists on Ivy Bridge model 62.
...
::
          ...
          The following modifiers are supported on Intel Ivy Bridge R3PQI
          uncore PMU:
          ...
          t      Set the threshold value. When set to a non-zero value, the
                 counter counts the number of R3QPI cycles in which the
