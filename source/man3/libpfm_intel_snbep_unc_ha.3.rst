...
libpfm_intel_snbep_unc_ha(3) — Linux manual page
================================================
...
::
          ...
          libpfm_intel_snbep_unc_ha - support for Intel Sandy Bridge-EP
          Home Agent (HA) uncore PMU
...
::
          ...
          PMU name: snbep_unc_ha
          PMU desc: Intel Sandy Bridge-EP HA uncore PMU
...
::
          ...
          The library supports the Intel Sandy Bridge Home Agent (HA)
          uncore PMU.  This PMU model only exists on Sandy Bridge model 45.
          There is only one Home Agent per processor socket.
