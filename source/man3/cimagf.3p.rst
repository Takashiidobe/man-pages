...
::
   ...
   CIMAG(3P)               POSIX Programmer's Manual              CIMAG(3P)
...
::
          ...
          These functions shall return the imaginary part value (as a
          real).
...
::
          ...
          carg(3p), conj(3p), cproj(3p), creal(3p)
...
::
   ...
   IEEE/The Open Group               2017                         CIMAG(3P)
