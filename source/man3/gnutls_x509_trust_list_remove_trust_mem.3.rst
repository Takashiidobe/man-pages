...
gnutls_x509_trust_list_remove_trust_mem(3) — Linux manual page
==============================================================
...
::
   ...
   gnutls_x509_trust_list_remove_trust_mem(3)trust_list_remove_trust_mem(3)
...
::
          ...
          list, const gnutls_datum_t * cas, gnutls_x509_crt_fmt_t type);
...
::
          ...
          from the trusted list, and add them into a black list when
          needed.
...
::
   ...
   gnutls                        gnut3l.s7_.x2509_trust_list_remove_trust_mem(3)
