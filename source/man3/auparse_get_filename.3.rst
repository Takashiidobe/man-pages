...
auparse_get_filename(3) — Linux manual page
===========================================
...
::
          ...
          auparse_get_filename will return the name of the source file
          where the record was found if the source type is AUSOURCE_FILE or
          AUSOURCE_FILE_ARRAY. For other source types the return value will
          be NULL.
...
::
          ...
          auparse_get_line_number(3).  auparse_next_record(3).
