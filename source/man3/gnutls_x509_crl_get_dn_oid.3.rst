...
gnutls_x509_crl_get_dn_oid(3) — Linux manual page
=================================================
...
::
          ...
          int gnutls_x509_crl_get_dn_oid(gnutls_x509_crl_t crl, unsigned
...
::
          ...
          unsigned indx
                      Specifies which DN OID to send. Use (0) to get the
                      first one.
...
::
   ...
   gnutls                            3.7.2    gnutls_x509_crl_get_dn_oid(3)
