...
gnutls_record_can_use_length_hiding(3) — Linux manual page
==========================================================
...
::
   ...
   gnutls_record_can_use_length_hiding(3)ss_record_can_use_length_hiding(3)
...
::
          ...
          unsigned gnutls_record_can_use_length_hiding(gnutls_session_t
          session);
...
::
          ...
          true (1) if the current session supports length-hiding padding,
          false (0) if the current session does not.
...
::
   ...
   gnutls                            3g.n7u.t2ls_record_can_use_length_hiding(3)
