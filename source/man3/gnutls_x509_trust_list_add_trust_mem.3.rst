...
gnutls_x509_trust_list_add_trust_mem(3) — Linux manual page
===========================================================
...
::
   ...
   gnutls_x509_trust_list_add_trust_mem(3)_x509_trust_list_add_trust_mem(3)
...
::
          ...
          int gnutls_x509_trust_list_add_trust_mem(gnutls_x509_trust_list_t
          list, const gnutls_datum_t * cas, const gnutls_datum_t * crls,
...
::
   ...
   gnutls                           g3n.u7t.l2s_x509_trust_list_add_trust_mem(3)
