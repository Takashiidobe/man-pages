...
gnutls_pubkey_export_gost_raw2(3) — Linux manual page
=====================================================
...
::
   ...
   gnutls_pubkey_export_gost_raw2(3)gnutlsgnutls_pubkey_export_gost_raw2(3)
...
::
          ...
          gnutls_gost_paramset_t * paramset, gnutls_datum_t * x,
...
::
          ...
          This function will export the GOST public key's parameters found
          in the given key.  The new parameters will be allocated using
...
::
   ...
   gnutls                            3.7.2gnutls_pubkey_export_gost_raw2(3)
