...
cfsetispeed(3p) — Linux manual page
===================================
...
::
   ...
   CFSETISPEED(3P)         POSIX Programmer's Manual        CFSETISPEED(3P)
...
::
          ...
          otherwise, -1 shall be returned, and errno may be set to indicate
          the error.
...
::
          ...
          cfgetispeed(3p), cfgetospeed(3p), cfsetospeed(3p), tcsetattr(3p)
...
::
   ...
   IEEE/The Open Group               2017                   CFSETISPEED(3P)
