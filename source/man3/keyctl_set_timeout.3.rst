...
keyctl_set_timeout(3) — Linux manual page
=========================================
...
::
          ...
          timeout seconds into the future.  Setting timeout to zero cancels
          the expiration, assuming the key hasn't already expired.

          When the key expires, further attempts to access it will be met
          with error EKEYEXPIRED.
...
::
          ...
          On success keyctl_set_timeout() returns 0 .  On error, the value
