...
rdma_get_src_port(3) — Linux manual page
========================================
...
::
          ...
          Returns the local port number for an rdma_cm_id that has been
...
::
          ...
          Returns the 16-bit port identifier associated with the local
          endpoint.  If the rdma_cm_id is not bound to a port, the returned
          value is 0.
