...
gnutls_x509_crt_list_import_url(3) — Linux manual page
======================================================
...
::
   ...
   gnutls_x509_crt_list_import_url(3)nutlsnutls_x509_crt_list_import_url(3)
...
::
          ...
          unsigned int * size, const char * url, gnutls_pin_callback_t
...
::
          ...
          unsigned int flags
                      One of GNUTLS_PKCS11_OBJ_* flags for PKCS11 URLs or
                      zero otherwise
...
::
          ...
          gnutls_x509_crt_deinit() and the returned pointer must be freed
          using gnutls_free().
...
::
   ...
   gnutls                            3.7.2gnutls_x509_crt_list_import_url(3)
