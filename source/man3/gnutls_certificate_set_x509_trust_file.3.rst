...
gnutls_certificate_set_x509_trust_file(3) — Linux manual page
=============================================================
...
::
   ...
   gnutls_certificate_set_x509_trust_file(3)tificate_set_x509_trust_file(3)
...
::
          ...
          const char * cafile
                      is a file containing the list of trusted CAs (DER or
                      PEM list)
...
::
   ...
   gnutls                         gnu3t.l7s._2certificate_set_x509_trust_file(3)
