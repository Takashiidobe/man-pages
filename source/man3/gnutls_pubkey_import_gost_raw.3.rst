...
gnutls_pubkey_import_gost_raw(3) — Linux manual page
====================================================
...
::
   ...
   gnutls_pubkey_import_gost_raw(3) gnutls gnutls_pubkey_import_gost_raw(3)
...
::
          ...
          int gnutls_pubkey_import_gost_raw(gnutls_pubkey_t key,
...
::
          ...
          is set to GNUTLS_GOST_PARAMSET_UNKNOWN default one will be
          selected depending on  digest .
...
::
   ...
   gnutls                            3.7.2 gnutls_pubkey_import_gost_raw(3)
