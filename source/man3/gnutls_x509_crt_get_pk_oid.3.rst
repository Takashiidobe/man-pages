...
gnutls_x509_crt_get_pk_oid(3) — Linux manual page
=================================================
...
::
   ...
   gnutls_x509_crt_get_pk_oid(3)    gnutls    gnutls_x509_crt_get_pk_oid(3)
...
::
          ...
          int gnutls_x509_crt_get_pk_oid(gnutls_x509_crt_t cert, char *
          oid, size_t * oid_size);
...
::
   ...
   gnutls                            3.7.2    gnutls_x509_crt_get_pk_oid(3)
