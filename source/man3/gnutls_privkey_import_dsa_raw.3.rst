...
gnutls_privkey_import_dsa_raw(3) — Linux manual page
====================================================
...
::
          ...
          int gnutls_privkey_import_dsa_raw(gnutls_privkey_t key, const
...
::
   ...
   gnutls                            3.7.2 gnutls_privkey_import_dsa_raw(3)
