...
gnutls_dtls_cookie_verify(3) — Linux manual page
================================================
...
::
          ...
          int gnutls_dtls_cookie_verify(gnutls_datum_t * key, void *
...
::
          ...
          This function will verify the received message for a valid
          cookie. If a valid cookie is returned then it should be
...
::
   ...
   gnutls                            3.7.2     gnutls_dtls_cookie_verify(3)
