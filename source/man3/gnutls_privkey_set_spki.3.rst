...
gnutls_privkey_set_spki(3) — Linux manual page
==============================================
...
::
   ...
   gnutls_privkey_set_spki(3)       gnutls       gnutls_privkey_set_spki(3)
...
::
          ...
          int gnutls_privkey_set_spki(gnutls_privkey_t privkey, const
...
::
   ...
   gnutls                            3.7.2       gnutls_privkey_set_spki(3)
