...
::
          ...
          The fesetenv() function shall attempt to establish the floating-
          ...
          fegetenv() or feholdexcept(), or equal a floating-point
...
`fesetenv(3p) <../man3/fesetenv.3p.html>`__, 
