...
libpfm_intel_ivbep_unc_ubo(3) — Linux manual page
=================================================
...
::
          ...
          libpfm_intel_ivbep_unc_ubo - support for Intel Ivy Bridge-EP U-
          Box uncore PMU
...
::
          ...
          PMU name: ivbep_unc_ubo
          PMU desc: Intel Ivy Bridge-EP U-Box uncore PMU
...
::
          ...
          The library supports the Intel Ivy Bridge system configuration
          unit (U-Box) uncore PMU.  This PMU model only exists on Ivy
          Bridge model 62.
...
::
          ...
          The following modifiers are supported on Intel Ivy Bridge U-Box
          uncore PMU:
