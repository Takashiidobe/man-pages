...
cfsetospeed(3p) — Linux manual page
===================================
...
::
   ...
   CFSETOSPEED(3P)         POSIX Programmer's Manual        CFSETOSPEED(3P)
...
::
          ...
          otherwise, it shall return -1 and errno may be set to indicate
          the error.
...
::
          ...
          cfgetispeed(3p), cfgetospeed(3p), cfsetispeed(3p), tcsetattr(3p)
...
::
   ...
   IEEE/The Open Group               2017                   CFSETOSPEED(3P)
