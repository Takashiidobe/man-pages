...
gnutls_x509_privkey_export_gost_raw(3) — Linux manual page
==========================================================
...
::
   ...
   gnutls_x509_privkey_export_gost_raw(3)ss_x509_privkey_export_gost_raw(3)
...
::
          ...
          int gnutls_x509_privkey_export_gost_raw(gnutls_x509_privkey_t
          key, gnutls_ecc_curve_t * curve, gnutls_digest_algorithm_t *
...
::
   ...
   gnutls                            3g.n7u.t2ls_x509_privkey_export_gost_raw(3)
