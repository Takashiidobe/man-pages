...
gnutls_pubkey_verify_hash2(3) — Linux manual page
=================================================
...
::
          ...
          is returned, and zero or positive code on success. For known to
          be insecure signatures this function will return
          GNUTLS_E_INSUFFICIENT_SECURITY unless the flag
...
::
   ...
   gnutls                            3.7.2    gnutls_pubkey_verify_hash2(3)
