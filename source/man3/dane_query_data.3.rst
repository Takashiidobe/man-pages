...
dane_query_data(3) — Linux manual page
======================================
...
::
          ...
          int dane_query_data(dane_query_t q, unsigned int idx, unsigned
          int * usage, unsigned int * type, unsigned int * match,
          gnutls_datum_t * data);
...
::
   ...
   gnutls                            3.7.2               dane_query_data(3)
