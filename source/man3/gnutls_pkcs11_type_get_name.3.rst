...
gnutls_pkcs11_type_get_name(3) — Linux manual page
==================================================
...
::
   ...
   gnutls_pkcs11_type_get_name(3)   gnutls   gnutls_pkcs11_type_get_name(3)
...
::
          ...
          gnutls_pkcs11_obj_type_t type
                      Holds the PKCS 11 object type, a
...
::
   ...
   gnutls                            3.7.2   gnutls_pkcs11_type_get_name(3)
