...
::
          ...
          The ftello() function shall be equivalent to ftell(), except that
          the return value is of type off_t and the ftello() function may
...
::
          ...
          current value of the file-position indicator for the stream
...
::
          ...
          EOVERFLOW
                 For ftello(), the current file offset cannot be
...
::
          ...
          Section 2.5, Standard I/O Streams, fgetpos(3p), fopen(3p),
          fseek(3p), lseek(3p)
