...
gnutls_pubkey_encrypt_data(3) — Linux manual page
=================================================
...
::
          ...
          int gnutls_pubkey_encrypt_data(gnutls_pubkey_t key, unsigned int
          flags, const gnutls_datum_t * plaintext, gnutls_datum_t *
          ciphertext);
...
::
   ...
   gnutls                            3.7.2    gnutls_pubkey_encrypt_data(3)
