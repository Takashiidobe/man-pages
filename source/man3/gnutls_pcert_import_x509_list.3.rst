...
gnutls_pcert_import_x509_list(3) — Linux manual page
====================================================
...
::
          ...
          gnutls_x509_crt_t * crt, unsigned * ncrt, unsigned int flags);
...
::
          ...
          unsigned * ncrt
                      The number of certificates in  crt ; will be updated
                      if necessary
...
::
          ...
          This convenience function will import the given certificates to
          an already allocated set of gnutls_pcert_st structures. The
...
::
   ...
   gnutls                            3.7.2 gnutls_pcert_import_x509_list(3)
