...
gnutls_certificate_type_get2(3) — Linux manual page
===================================================
...
::
          ...
          certificate type for the client (GNUTLS_CTYPE_CLIENT), or for the
          server (GNUTLS_CTYPE_SERVER). Additionally, in P2P mode
...
::
          ...
          the currently used gnutls_certificate_type_t certificate type for
...
::
   ...
   gnutls                            3.7.2  gnutls_certificate_type_get2(3)
