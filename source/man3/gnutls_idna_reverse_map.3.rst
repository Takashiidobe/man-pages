...
gnutls_idna_reverse_map(3) — Linux manual page
==============================================
...
::
          ...
          gnutls_datum_t * out
                      the result in an null-terminated allocated UTF-8
                      string
...
::
          ...
          This function will convert an ACE (ASCII-encoded) domain name to
          a UTF-8 domain name.
...
::
   ...
   gnutls                            3.7.2       gnutls_idna_reverse_map(3)
