...
::
   ...
   gnutls_x509_crl_iter_crt_serial(3)nutlsnutls_x509_crl_iter_crt_serial(3)
...
::
          ...
          gnutls_x509_crl_iter_t * iter, unsigned char * serial, size_t *
          serial_size, time_t * t);
...
::
   ...
   gnutls                            3.7.2gnutls_x509_crl_iter_crt_serial(3)
