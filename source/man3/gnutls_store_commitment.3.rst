...
gnutls_store_commitment(3) — Linux manual page
==============================================
...
::
          ...
          int gnutls_store_commitment(const char * db_name, gnutls_tdb_t
          tdb, const char * host, const char * service,
          gnutls_digest_algorithm_t hash_algo, const gnutls_datum_t * hash,
