...
gnutls_pubkey_import_tpm_raw(3) — Linux manual page
===================================================
...
::
   ...
   gnutls_pubkey_import_tpm_raw(3)  gnutls  gnutls_pubkey_import_tpm_raw(3)
...
::
          ...
          int gnutls_pubkey_import_tpm_raw(gnutls_pubkey_t pkey, const
...
::
          ...
          This function will import the public key from the provided TPM
          key structure.
...
::
   ...
   gnutls                            3.7.2  gnutls_pubkey_import_tpm_raw(3)
