...
::
          ...
          These functions shall compute the complex arc hyperbolic cosine
          of z, with a branch cut at values less than 1 along the real
          axis.
...
::
          ...
          the real axis and in the interval [-iπ, +iπ] along the imaginary
          axis.
