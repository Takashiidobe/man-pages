...
gnutls_cipher_suite_info(3) — Linux manual page
===============================================
...
::
          ...
          const char * gnutls_cipher_suite_info(size_t idx, unsigned char *
...
::
          ...
          size_t idx  index of cipher suite to get information about,
                      starts on 0.

          unsigned char * cs_id
                      output buffer with room for 2 bytes, indicating
                      cipher suite value
...
::
          ...
          the name of  idx cipher suite, and set the information about the
          cipher suite in the output variables.  If  idx is out of bounds,
          NULL is returned.
...
::
   ...
   gnutls                            3.7.2      gnutls_cipher_suite_info(3)
