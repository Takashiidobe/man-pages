...
::
   ...
   gnutls_x509_crl_get_crt_count(3) gnutls gnutls_x509_crl_get_crt_count(3)
...
::
          ...
          This function will return the number of revoked certificates in
          the given CRL.
...
::
   ...
   gnutls                            3.7.2 gnutls_x509_crl_get_crt_count(3)
