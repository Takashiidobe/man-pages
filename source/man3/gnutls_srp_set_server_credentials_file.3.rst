...
gnutls_srp_set_server_credentials_file(3) — Linux manual page
=============================================================
...
::
   ...
   gnutls_srp_set_server_credentials_file(3)_set_server_credentials_file(3)
...
::
          ...
          res, const char * password_file, const char *
          password_conf_file);
...
::
   ...
   gnutls                         gnu3t.l7s._2srp_set_server_credentials_file(3)
