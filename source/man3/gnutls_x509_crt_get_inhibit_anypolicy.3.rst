...
gnutls_x509_crt_get_inhibit_anypolicy(3) — Linux manual page
============================================================
...
::
   ...
   gnutls_x509_crt_get_inhibit_anypolicy(3)509_crt_get_inhibit_anypolicy(3)
...
::
          ...
          zero on success, or a negative error code in case of parsing
          error.  If the certificate does not contain the Inhibit anyPolicy
...
::
   ...
   gnutls                          gn3u.t7l.s2_x509_crt_get_inhibit_anypolicy(3)
