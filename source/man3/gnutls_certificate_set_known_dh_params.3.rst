...
gnutls_certificate_set_known_dh_params(3) — Linux manual page
=============================================================
...
::
   ...
   gnutls_certificate_set_known_dh_params(3)tificate_set_known_dh_params(3)
...
::
          ...
          int
          gnutls_certificate_set_known_dh_params(gnutls_certificate_credentials_t
...
::
          ...
          the FFDHE set of RFC7919 according to the security level
          provided.
...
::
   ...
   gnutls                         gnu3t.l7s._2certificate_set_known_dh_params(3)
