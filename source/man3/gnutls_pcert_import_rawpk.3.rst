...
gnutls_pcert_import_rawpk(3) — Linux manual page
================================================
...
::
          ...
          gnutls_pubkey_t pubkey
                      The raw public-key in gnutls_pubkey_t format to be
                      imported
...
::
          ...
          raw public key  pubkey into a gnutls_pcert_st structure. The
...
::
   ...
   gnutls                            3.7.2     gnutls_pcert_import_rawpk(3)
