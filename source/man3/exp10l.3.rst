...
::
          ...
          functions did not set errno to ERANGE when an underflow error
          occurred.
...
Pages that refer to this page: `exp2(3) <../man3/exp2.3.html>`__, 
`exp(3) <../man3/exp.3.html>`__,  `log10(3) <../man3/log10.3.html>`__, 
`pow10(3) <../man3/pow10.3.html>`__

--------------

`Copyright and license for this manual
page <../man3/exp10.3.license.html>`__
