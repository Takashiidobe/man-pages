...
sched_rr_get_interval(3p) — Linux manual page
=============================================
...
::
   ...
   SCHED_RR_GET_INTERVAL(3P)OSIX Programmer's ManualHED_RR_GET_INTERVAL(3P)
...
::
          ...
          process specified by pid.  If pid is zero, the current execution
          time limit for the calling process shall be returned.
...
::
          ...
          sched_getparam(3p), sched_get_priority_max(3p),
