...
::
          ...
          gnutls_x509_crt_t * certs
                      Indicates where the parsed list will be copied to.
...
::
          ...
          import to fail if the certificates in the provided buffer are
          more than the available structures. The
...
::
   ...
   gnutls                            3.7.2   gnutls_x509_crt_list_import(3)
