...
dane_query_tlsa(3) — Linux manual page
======================================
...
::
          ...
          int dane_query_tlsa(dane_state_t s, dane_query_t * r, const char
          * host, const char * proto, unsigned int port);
...
::
   ...
   gnutls                            3.7.2               dane_query_tlsa(3)
