...
gnutls_x509_crq_get_tlsfeatures(3) — Linux manual page
======================================================
...
::
   ...
   gnutls_x509_crq_get_tlsfeatures(3)nutlsnutls_x509_crq_get_tlsfeatures(3)
...
::
          ...
          gnutls_x509_tlsfeatures_t features, unsigned int flags, unsigned
          int * critical);
...
::
          ...
          gnutls_x509_tlsfeatures_t features
                      If the function succeeds, the features will be stored
                      in this variable.
...
::
   ...
   gnutls                            3.7.2gnutls_x509_crq_get_tlsfeatures(3)
