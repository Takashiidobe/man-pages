...
gnutls_x509_privkey_import_ecc_raw(3) — Linux manual page
=========================================================
...
::
   ...
   gnutls_x509_privkey_import_ecc_raw(3)lsls_x509_privkey_import_ecc_raw(3)
...
::
          ...
          stored in  key . For EdDSA keys, the  x and  k values must be in
          the native to curve format.
...
::
   ...
   gnutls                            3.g7n.u2tls_x509_privkey_import_ecc_raw(3)
