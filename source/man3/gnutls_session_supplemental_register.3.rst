...
gnutls_session_supplemental_register(3) — Linux manual page
===========================================================
...
::
   ...
   gnutls_session_supplemental_register(3)_session_supplemental_register(3)
...
::
          ...
          int gnutls_session_supplemental_register(gnutls_session_t
...
::
          ...
          (rfc4680).  The registered supplemental functions will be used
          for that specific session. The provided  type must be an
          unassigned type in gnutls_supplemental_data_format_type_t.
...
::
   ...
   gnutls                           g3n.u7t.l2s_session_supplemental_register(3)
