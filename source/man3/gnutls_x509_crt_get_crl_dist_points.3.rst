...
gnutls_x509_crt_get_crl_dist_points(3) — Linux manual page
==========================================================
...
::
   ...
   gnutls_x509_crt_get_crl_dist_points(3)ss_x509_crt_get_crl_dist_points(3)
...
::
          ...
          void * san  is the place where the distribution point will be
                      copied to
...
::
   ...
   gnutls                            3g.n7u.t2ls_x509_crt_get_crl_dist_points(3)
