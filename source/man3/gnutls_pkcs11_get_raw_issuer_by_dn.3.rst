...
gnutls_pkcs11_get_raw_issuer_by_dn(3) — Linux manual page
=========================================================
...
::
   ...
   gnutls_pkcs11_get_raw_issuer_by_dn(3)lsls_pkcs11_get_raw_issuer_by_dn(3)
...
::
          ...
          int gnutls_pkcs11_get_raw_issuer_by_dn(const char * url, const
          gnutls_datum_t * dn, gnutls_datum_t * issuer,
...
::
          ...
          This function will return the certificate with the given DN, if
...
::
   ...
   gnutls                            3.g7n.u2tls_pkcs11_get_raw_issuer_by_dn(3)
