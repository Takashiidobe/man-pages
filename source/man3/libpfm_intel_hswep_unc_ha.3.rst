...
libpfm_intel_hswep_unc_ha(3) — Linux manual page
================================================
...
::
          ...
          libpfm_intel_hswep_unc_ha - support for Intel Haswell-EP Home
          Agent (HA) uncore PMU
...
::
          ...
          PMU name: hswep_unc_ha0, hswep_unc_ha1
          PMU desc: Intel Haswell-EP HA uncore PMU
...
::
          ...
          The library supports the Intel Haswell Home Agent (HA) uncore
          PMU.  This PMU model only exists on Haswell model 63.
...
::
          ...
          The following modifiers are supported on Intel Haswell HA uncore
          PMU:
