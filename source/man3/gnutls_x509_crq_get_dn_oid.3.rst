...
gnutls_x509_crq_get_dn_oid(3) — Linux manual page
=================================================
...
::
          ...
          int gnutls_x509_crq_get_dn_oid(gnutls_x509_crq_t crq, unsigned
...
::
          ...
          unsigned indx
                      Specifies which DN OID to get. Use (0) to get the
                      first one.

          void * oid  a pointer to a structure to hold the name (may be
                      NULL)
...
::
   ...
   gnutls                            3.7.2    gnutls_x509_crq_get_dn_oid(3)
