...
gnutls_x509_crt_check_ip(3) — Linux manual page
===============================================
...
::
          ...
          unsigned gnutls_x509_crt_check_ip(gnutls_x509_crt_t cert, const
          unsigned char * ip, unsigned int ip_size, unsigned int flags);
...
::
   ...
   gnutls                            3.7.2      gnutls_x509_crt_check_ip(3)
