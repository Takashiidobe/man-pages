...
gnutls_priority_set(3) — Linux manual page
==========================================
...
::
          ...
          re-handshake, the caller should make sure that any new settings
          are not incompatible with the original session).
...
::
   ...
   gnutls                            3.7.2           gnutls_priority_set(3)
