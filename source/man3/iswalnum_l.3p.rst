...
::
          ...
          iswalnum, iswalnum_l — test for an alphanumeric wide-character
          code
...
::
          ...
          For iswalnum(): The functionality described on this reference
          page is aligned with the ISO C standard. Any conflict between the
          requirements described here and the ISO C standard is
          unintentional. This volume of POSIX.1‐2017 defers to the ISO C
          standard.

          The iswalnum() and iswalnum_l() functions shall test whether wc
          is a wide-character code representing a character of class alpha
          or digit in the current locale, or in the locale represented by
          ...
          The behavior is undefined if the locale argument to iswalnum_l()
...
::
          ...
          The iswalnum() and iswalnum_l() functions shall return non-zero
          if wc is an alphanumeric wide-character code; otherwise, they
          shall return 0.
