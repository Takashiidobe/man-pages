...
cfgetospeed(3p) — Linux manual page
===================================
...
::
   ...
   CFGETOSPEED(3P)         POSIX Programmer's Manual        CFGETOSPEED(3P)
...
::
          ...
          from the termios structure to which the termios_p argument
          points.
...
::
          ...
          type speed_t representing the output baud rate.
...
::
   ...
   IEEE/The Open Group               2017                   CFGETOSPEED(3P)
