...
::
          ...
          The wmemcpy() function shall copy n wide characters from the
          object pointed to by ws2 to the object pointed to by ws1.  This
...
::
          ...
          wmemchr(3p), wmemcmp(3p), wmemmove(3p), wmemset(3p)
