...
gnutls_x509_crl_export(3) — Linux manual page
=============================================
...
::
          ...
          This function will export the revocation list to DER or PEM
          format.

          If the buffer provided is not long enough to hold the output,
          then GNUTLS_E_SHORT_MEMORY_BUFFER will be returned.
...
::
   ...
   gnutls                            3.7.2        gnutls_x509_crl_export(3)
