...
::
          ...
          representable, a range error may occur, and ldexp(), ldexpf(),
          and ldexpl() shall return 0.0, or (if IEC 60559 Floating-Point is
...
::
          ...
          feclearexcept(3p), fetestexcept(3p), frexp(3p), isnan(3p)
