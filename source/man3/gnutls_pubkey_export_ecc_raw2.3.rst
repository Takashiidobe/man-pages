...
gnutls_pubkey_export_ecc_raw2(3) — Linux manual page
====================================================
...
::
   ...
   gnutls_pubkey_export_ecc_raw2(3) gnutls gnutls_pubkey_export_ecc_raw2(3)
...
::
          ...
          This function will export the ECC public key's parameters found
...
::
   ...
   gnutls                            3.7.2 gnutls_pubkey_export_ecc_raw2(3)
