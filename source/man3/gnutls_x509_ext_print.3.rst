...
gnutls_x509_ext_print(3) — Linux manual page
============================================
...
::
   ...
   gnutls_x509_ext_print(3)         gnutls         gnutls_x509_ext_print(3)
...
::
          ...
          int gnutls_x509_ext_print(gnutls_x509_ext_st * exts, unsigned int
          exts_size, gnutls_certificate_print_formats_t format,
          gnutls_datum_t * out);
...
::
   ...
   gnutls                            3.7.2         gnutls_x509_ext_print(3)
