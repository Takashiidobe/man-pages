...
gnutls_tdb_set_verify_func(3) — Linux manual page
=================================================
...
::
   ...
   gnutls_tdb_set_verify_func(3)    gnutls    gnutls_tdb_set_verify_func(3)
...
::
   ...
   gnutls                            3.7.2    gnutls_tdb_set_verify_func(3)
