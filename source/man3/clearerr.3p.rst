...
::
   ...
   CLEARERR(3P)            POSIX Programmer's Manual           CLEARERR(3P)
...
::
          ...
          The clearerr() function shall not change the setting of errno if
          stream is valid.
...
::
   ...
   IEEE/The Open Group               2017                      CLEARERR(3P)
