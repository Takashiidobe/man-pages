...
gnutls_pubkey_set_pin_function(3) — Linux manual page
=====================================================
...
::
   ...
   gnutls_pubkey_set_pin_function(3)gnutlsgnutls_pubkey_set_pin_function(3)
...
::
   ...
   gnutls                            3.7.2gnutls_pubkey_set_pin_function(3)
