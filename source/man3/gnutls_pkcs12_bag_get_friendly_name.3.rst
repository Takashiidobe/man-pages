...
gnutls_pkcs12_bag_get_friendly_name(3) — Linux manual page
==========================================================
...
::
   ...
   gnutls_pkcs12_bag_get_friendly_name(3)ss_pkcs12_bag_get_friendly_name(3)
...
::
          ...
          char ** name
                      will hold a pointer to the name (to be treated as
                      const)
...
::
   ...
   gnutls                            3g.n7u.t2ls_pkcs12_bag_get_friendly_name(3)
