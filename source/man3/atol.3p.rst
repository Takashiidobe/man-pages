...
::
          ...
          Except as noted below, the call atol(nptr) shall be equivalent
          to:

              strtol(nptr, (char **)NULL, 10)

          Except as noted below, the call to atoll(nptr) shall be
          equivalent to:

              strtoll(nptr, (char **)NULL, 10)

          The handling of errors may differ. If the value cannot be
