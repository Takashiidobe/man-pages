...
libpfm_intel_hswep_unc_ubo(3) — Linux manual page
=================================================
...
::
          ...
          libpfm_intel_hswep_unc_ubo - support for Intel Haswell-EP U-Box
          uncore PMU
...
::
          ...
          PMU name: hswep_unc_ubo
          PMU desc: Intel Haswell-EP U-Box uncore PMU
...
::
          ...
          The library supports the Intel Haswell system configuration unit
          (U-Box) uncore PMU.  This PMU model only exists on Haswell model
          63.
...
::
          ...
          The following modifiers are supported on Intel Haswell U-Box
          uncore PMU:
