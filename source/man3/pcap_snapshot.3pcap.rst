...
pcap_snapshot(3pcap) — Linux manual page
========================================
...
::
          ...
          pcap_set_snaplen(3PCAP) or pcap_open_live(3PCAP) was called, for
          a live capture, or the snapshot length from the capture file, for
          a ``savefile''.
