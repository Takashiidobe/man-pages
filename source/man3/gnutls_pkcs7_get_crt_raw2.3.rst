...
gnutls_pkcs7_get_crt_raw2(3) — Linux manual page
================================================
...
::
          ...
          int gnutls_pkcs7_get_crt_raw2(gnutls_pkcs7_t pkcs7, unsigned
          indx, gnutls_datum_t * cert);
...
::
          ...
          gnutls_datum_t * cert
                      will hold the contents of the certificate; must be
...
::
   ...
   gnutls                            3.7.2     gnutls_pkcs7_get_crt_raw2(3)
