...
fpclassify(3p) — Linux manual page
==================================
...
::
   ...
   FPCLASSIFY(3P)          POSIX Programmer's Manual         FPCLASSIFY(3P)
...
::
          ...
          implementation-defined category.  First, an argument represented
          in a format wider than its semantic type is converted to its
          semantic type. Then classification is based on the type of the
          argument.
...
::
          ...
          isfinite(3p), isinf(3p), isnan(3p), isnormal(3p), signbit(3p)
...
::
   ...
   IEEE/The Open Group               2017                    FPCLASSIFY(3P)
