...
gnutls_priority_certificate_type_list(3) — Linux manual page
============================================================
...
::
   ...
   gnutls_priority_certificate_type_list(3)riority_certificate_type_list(3)
...
::
          ...
          int gnutls_priority_certificate_type_list(gnutls_priority_t
...
::
   ...
   gnutls                          gn3u.t7l.s2_priority_certificate_type_list(3)
