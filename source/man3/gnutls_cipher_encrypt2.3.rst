...
gnutls_cipher_encrypt2(3) — Linux manual page
=============================================
...
::
          ...
          int gnutls_cipher_encrypt2(gnutls_cipher_hd_t handle, const void
          * ptext, size_t ptext_len, void * ctext, size_t ctext_len);
...
::
   ...
   gnutls                            3.7.2        gnutls_cipher_encrypt2(3)
