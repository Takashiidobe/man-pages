...
::
          ...
          For iscntrl(): The functionality described on this reference page
          is aligned with the ISO C standard. Any conflict between the
          requirements described here and the ISO C standard is
          unintentional. This volume of POSIX.1‐2017 defers to the ISO C
          standard.

          The iscntrl() and iscntrl_l() functions shall test whether c is a
          character of class cntrl in the current locale, or in the locale
          ...
          The behavior is undefined if the locale argument to iscntrl_l()
...
::
          ...
          The iscntrl() and iscntrl_l() functions shall return non-zero if
          c is a control character; otherwise, they shall return 0.
...
::
          ...
          isalnum(3p), isalpha(3p), isblank(3p), isdigit(3p), isgraph(3p),
...
::
   ...
   IEEE/The Open Group               2017                       ISCNTRL(3P)
