...
tcgetpgrp(3p) — Linux manual page
=================================
...
::
          ...
          member of a background process group; however, the information
          may be subsequently changed by a process that is a member of a
...
::
          ...
          setsid(3p), setpgid(3p), tcsetpgrp(3p)
