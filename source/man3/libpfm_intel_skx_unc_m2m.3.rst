...
libpfm_intel_skx_unc_m2m(3) — Linux manual page
===============================================
...
::
          ...
          libpfm_intel_skx_unc_m2m - support for Intel Skylake X Server M2M
          uncore PMU
...
::
          ...
          PMU name: skx_unc_m2m[0-1]
          PMU desc: Intel Skylake X Server Mesh-2-Memory uncore PMU
...
::
          ...
          The library supports the Intel Skylake X server system
          configuration unit M2M uncore PMU.
