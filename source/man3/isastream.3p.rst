...
isastream(3p) — Linux manual page
=================================
...
::
   ...
   ISASTREAM(3P)           POSIX Programmer's Manual          ISASTREAM(3P)
...
::
          ...
          isastream() shall return -1 and set errno to indicate the error.
...
::
   ...
   IEEE/The Open Group               2017                     ISASTREAM(3P)
