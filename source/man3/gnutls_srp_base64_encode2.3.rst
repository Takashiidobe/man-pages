...
gnutls_srp_base64_encode2(3) — Linux manual page
================================================
...
::
          ...
          using the base64 encoding.  This is the encoding used in SRP
          password files.  This function will allocate the required memory
...
::
   ...
   gnutls                            3.7.2     gnutls_srp_base64_encode2(3)
