...
audit_log_user_avc_message(3) — Linux manual page
=================================================
...
::
          ...
          int audit_log_user_avc_message(int audit_fd, int type, const char
...
::
          ...
          apps that are SE Linux object managers. The function parameters
          are as follows:
...
::
          ...
          audit_log_user_comm_message(3), audit_log_semanage_message(3).
