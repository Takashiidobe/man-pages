...
gnutls_x509_rdn_get_by_oid(3) — Linux manual page
=================================================
...
::
   ...
   gnutls_x509_rdn_get_by_oid(3)    gnutls    gnutls_x509_rdn_get_by_oid(3)
...
::
          ...
          int gnutls_x509_rdn_get_by_oid(const gnutls_datum_t * idn, const
...
::
   ...
   gnutls                            3.7.2    gnutls_x509_rdn_get_by_oid(3)
