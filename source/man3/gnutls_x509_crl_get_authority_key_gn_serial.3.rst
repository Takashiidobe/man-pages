...
gnutls_x509_crl_get_authority_key_gn_serial(3) — Linux manual page
==================================================================
...
::
   ...
   gnutls_x509_crl_get_authority_key_gn_serial(3)authority_key_gn_serial(3)
...
::
          ...
          crl, unsigned int seq, void * alt, size_t * alt_size, unsigned
          int * alt_type, void * serial, size_t * serial_size, unsigned int
          * critical);
...
::
          ...
          void * alt  is the place where the alternative name will be
                      copied to
...
::
   ...
   gnutls                    gnutls_x35.079._2crl_get_authority_key_gn_serial(3)
