...
gnutls_ocsp_req_add_cert(3) — Linux manual page
===============================================
...
::
          ...
          particular certificate.  The issuer name hash, issuer key hash,
          and serial number fields is populated as follows.  The issuer
          name and the serial number is taken from  cert .  The issuer key
          is taken from  issuer .  The hashed values will be hashed using
          the  digest algorithm, normally GNUTLS_DIG_SHA1.
...
::
   ...
   gnutls                            3.7.2      gnutls_ocsp_req_add_cert(3)
