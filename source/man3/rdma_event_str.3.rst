...
rdma_event_str(3) — Linux manual page
=====================================
...
::
          ...
          rdma_event_str - Returns a string representation of an rdma cm
          event.
...
::
          ...
          Returns a pointer to a static character string corresponding to
          the event.
