...
dane_verify_crt_raw(3) — Linux manual page
==========================================
...
::
          ...
          int dane_verify_crt_raw(dane_state_t s, const gnutls_datum_t *
          chain, unsigned chain_size, gnutls_certificate_type_t chain_type,
          dane_query_t r, unsigned int sflags, unsigned int vflags,
          unsigned int * verify);
...
::
          ...
          This is the low-level function of dane_verify_crt(). See the high
          level function for documentation.
...
::
   ...
   gnutls                            3.7.2           dane_verify_crt_raw(3)
