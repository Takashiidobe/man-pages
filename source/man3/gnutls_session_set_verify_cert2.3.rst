...
gnutls_session_set_verify_cert2(3) — Linux manual page
======================================================
...
::
   ...
   gnutls_session_set_verify_cert2(3)nutlsnutls_session_set_verify_cert2(3)
...
::
          ...
          gnutls_typed_vdata_st * data, unsigned elements, unsigned flags);
...
::
          ...
          gnutls_certificate_verify_peers(), and once set must remain valid
          for the lifetime of the session. More precisely they should be
          available during any subsequent handshakes.
...
::
   ...
   gnutls                            3.7.2gnutls_session_set_verify_cert2(3)
