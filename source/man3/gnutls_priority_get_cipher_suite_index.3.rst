...
gnutls_priority_get_cipher_suite_index(3) — Linux manual page
=============================================================
...
::
   ...
   gnutls_priority_get_cipher_suite_index(3)ority_get_cipher_suite_index(3)
...
::
          ...
          int gnutls_priority_get_cipher_suite_index(gnutls_priority_t
...
::
          ...
          unsigned int * sidx
                      internal index of cipher suite to get information
                      about.
...
::
          ...
          On success it returns GNUTLS_E_SUCCESS (0), or a negative error
          value otherwise.
...
::
   ...
   gnutls                         gnu3t.l7s._2priority_get_cipher_suite_index(3)
