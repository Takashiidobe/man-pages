...
gnutls_hex2bin(3) — Linux manual page
=====================================
...
::
          ...
          int gnutls_hex2bin(const char * hex_data, size_t hex_size, void *
...
::
          ...
          size_t * bin_size
                      when calling should hold maximum size of  bin_data ,
