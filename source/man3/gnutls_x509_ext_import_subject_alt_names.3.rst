...
gnutls_x509_ext_import_subject_alt_names(3) — Linux manual page
===============================================================
...
::
   ...
   gnutls_x509_ext_import_subject_alt_names(3)t_import_subject_alt_names(3)
...
::
          ...
          int gnutls_x509_ext_import_subject_alt_names(const gnutls_datum_t
          * ext, gnutls_subject_alt_names_t sans, unsigned int flags);
...
::
   ...
   gnutls                       gnutl3s._7x.5209_ext_import_subject_alt_names(3)
