...
ibv_modify_cq(3) — Linux manual page
====================================
...
::
   ...
   IBV_MODIFY_CQ(3)     Libibverbs Programmer's Manual     IBV_MODIFY_CQ(3)
...
::
          ...
          The function ibv_modify_cq() will modify the CQ, based on the
          given cq_attr->attr_mask
...
::
   ...
   libibverbs                     2017-10-20               IBV_MODIFY_CQ(3)
