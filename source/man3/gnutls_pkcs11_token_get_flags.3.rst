...
gnutls_pkcs11_token_get_flags(3) — Linux manual page
====================================================
...
::
          ...
          int gnutls_pkcs11_token_get_flags(const char * url, unsigned int
          * flags);
...
::
   ...
   gnutls                            3.7.2 gnutls_pkcs11_token_get_flags(3)
