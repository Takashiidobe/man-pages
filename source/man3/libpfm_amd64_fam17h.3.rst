...
libpfm_amd64_fam17h(3) — Linux manual page
==========================================
...
::
          ...
          The library supports AMD Family 17h processors Zen1 core PMU in
          both 32 and 64-bit modes.  The amd64_fam17h PMU model name has
          been deprecated in favor of amd_fam17h_zen1. The old name is
          maintained for backward compatibility reasons, but should not be
          used anymore.
...
::
          ...
          The following modifiers are supported on AMD64 Family 17h Zen1
          core PMU:
