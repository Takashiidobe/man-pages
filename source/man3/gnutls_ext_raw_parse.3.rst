...
gnutls_ext_raw_parse(3) — Linux manual page
===========================================
...
::
          ...
          int gnutls_ext_raw_parse(void * ctx, gnutls_ext_raw_process_func
          cb, const gnutls_datum_t * data, unsigned int flags);
...
::
          ...
          unsigned int flags
                      should be zero or
                      GNUTLS_EXT_RAW_FLAG_TLS_CLIENT_HELLO or
...
::
          ...
          function will parse the extension data from the position, as if
          the packet in
...
::
          ...
          GNUTLS_E_SUCCESS on success, or an error code. On unknown flags
          it returns GNUTLS_E_INVALID_REQUEST.
...
::
   ...
   gnutls                            3.7.2          gnutls_ext_raw_parse(3)
