...
posix_trace_attr_setlogsize(3p) — Linux manual page
===================================================
...
::
   ...
   POSIX_TRACE_ATTR_SETLOGSIZE(3P)rogrammer'sOManualACE_ATTR_SETLOGSIZE(3P)
...
::
   ...
   IEEE/The Open Group               2017   POSIX_TRACE_ATTR_SETLOGSIZE(3P)
