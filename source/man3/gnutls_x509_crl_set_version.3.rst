...
gnutls_x509_crl_set_version(3) — Linux manual page
==================================================
...
::
   ...
   gnutls_x509_crl_set_version(3)   gnutls   gnutls_x509_crl_set_version(3)
...
::
          ...
          int gnutls_x509_crl_set_version(gnutls_x509_crl_t crl, unsigned
          int version);
...
::
   ...
   gnutls                            3.7.2   gnutls_x509_crl_set_version(3)
