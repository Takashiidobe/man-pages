...
gai_strerror(3p) — Linux manual page
====================================
...
::
   ...
   GAI_STRERROR(3P)        POSIX Programmer's Manual       GAI_STRERROR(3P)
...
::
          ...
          When the ecode argument is one of the following values listed in
          the <netdb.h> header:
          ...
          shall return a pointer to a string whose contents indicate an
          unknown error.
...
::
   ...
   IEEE/The Open Group               2017                  GAI_STRERROR(3P)
