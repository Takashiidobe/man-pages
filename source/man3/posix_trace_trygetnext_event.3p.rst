...
posix_trace_trygetnext_event(3p) — Linux manual page
====================================================
...
::
   ...
   POSIX_TRACE_TRYGETNEXT_EVENT(3P)ogrammer'sSManualCE_TRYGETNEXT_EVENT(3P)
...
::
   ...
   IEEE/The Open Group               2017  POSIX_TRACE_TRYGETNEXT_EVENT(3P)
