...
::
   ...
   gnutls_ocsp_resp_get_status(3)   gnutls   gnutls_ocsp_resp_get_status(3)
...
::
          ...
          status of OCSP request as a gnutls_ocsp_resp_status_t, or a
...
::
   ...
   gnutls                            3.7.2   gnutls_ocsp_resp_get_status(3)
