...
gnutls_ocsp_req_set_extension(3) — Linux manual page
====================================================
...
::
   ...
   gnutls_ocsp_req_set_extension(3) gnutls gnutls_ocsp_req_set_extension(3)
...
::
          ...
          int gnutls_ocsp_req_set_extension(gnutls_ocsp_req_t req, const
...
::
          ...
          this function multiple times for the same OID will overwrite
...
::
   ...
   gnutls                            3.7.2 gnutls_ocsp_req_set_extension(3)
