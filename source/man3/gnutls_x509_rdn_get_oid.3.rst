...
gnutls_x509_rdn_get_oid(3) — Linux manual page
==============================================
...
::
          ...
          int gnutls_x509_rdn_get_oid(const gnutls_datum_t * idn, unsigned
          indx, void * buf, size_t * buf_size);
...
::
          ...
          unsigned indx
                      Indicates which OID to return. Use 0 for the first
                      one.
...
::
   ...
   gnutls                            3.7.2       gnutls_x509_rdn_get_oid(3)
