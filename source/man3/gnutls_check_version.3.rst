...
gnutls_check_version(3) — Linux manual page
===========================================
...
::
          ...
          as a string in  req_version and return the actual version string
          of the library; return NULL if the condition is not met.  If NULL
...
::
   ...
   gnutls                            3.7.2          gnutls_check_version(3)
