...
gnutls_handshake_set_hook_function(3) — Linux manual page
=========================================================
...
::
   ...
   gnutls_handshake_set_hook_function(3)lsls_handshake_set_hook_function(3)
...
::
          ...
          unsigned int htype, int when, gnutls_handshake_hook_func func);
...
::
          ...
          unsigned int htype
                      the gnutls_handshake_description_t of the message to
                      hook at

          int when    GNUTLS_HOOK_* depending on when the hook function
                      should be called
...
::
          ...
          This function will set a callback to be called after or before
          the specified handshake message has been received or generated.
...
::
   ...
   gnutls                            3.g7n.u2tls_handshake_set_hook_function(3)
