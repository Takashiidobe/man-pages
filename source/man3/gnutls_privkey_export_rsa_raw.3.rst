...
gnutls_privkey_export_rsa_raw(3) — Linux manual page
====================================================
...
::
   ...
   gnutls_privkey_export_rsa_raw(3) gnutls gnutls_privkey_export_rsa_raw(3)
...
::
          ...
          int gnutls_privkey_export_rsa_raw(gnutls_privkey_t key,
...
::
          ...
          datum. For EdDSA keys, the  y value should be NULL.
...
::
   ...
   gnutls                            3.7.2 gnutls_privkey_export_rsa_raw(3)
