...
::
   ...
   WMEMSET(3P)             POSIX Programmer's Manual            WMEMSET(3P)
...
::
          ...
          The wmemset() function shall copy the value of wc into each of
          the first n wide characters of the object pointed to by ws.  This
          function shall not be affected by locale and all wchar_t values
...
::
          ...
          wmemchr(3p), wmemcmp(3p), wmemcpy(3p), wmemmove(3p)
...
::
   ...
   IEEE/The Open Group               2017                       WMEMSET(3P)
