...
libpfm_intel_hswep_unc_r3qpi(3) — Linux manual page
===================================================
...
::
          ...
          libpfm_intel_hswep_unc_r3qpi - support for Intel Haswell-EP R3QPI
          uncore PMU
...
::
          ...
          PMU name: hswep_unc_r3qpi[0-2]
          PMU desc: Intel Haswell-EP R3QPI uncore PMU
...
::
          ...
          The library supports the Intel Haswell R3QPI uncore PMU.  This
          PMU model only exists on Haswell model 63.
...
::
          ...
          The following modifiers are supported on Intel Haswell R3PQI
          uncore PMU:
