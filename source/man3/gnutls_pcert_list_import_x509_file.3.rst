...
gnutls_pcert_list_import_x509_file(3) — Linux manual page
=========================================================
...
::
   ...
   gnutls_pcert_list_import_x509_file(3)lsls_pcert_list_import_x509_file(3)
...
::
          ...
          int gnutls_pcert_list_import_x509_file(gnutls_pcert_st *
...
::
          ...
          gnutls_x509_crt_fmt_t format
                      GNUTLS_X509_FMT_DER or GNUTLS_X509_FMT_PEM if a file
                      is given
...
::
          ...
          This convenience function will import a certificate chain from
          the given file or supported URI to gnutls_pcert_st structures.
          The structures must be deinitialized afterwards using
          gnutls_pcert_deinit().
...
::
   ...
   gnutls                            3.g7n.u2tls_pcert_list_import_x509_file(3)
