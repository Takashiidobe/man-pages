...
::
          ...
          These functions may lose accuracy when their argument is near an
          odd multiple of π/2 or is far from 0.
...
::
          ...
          acos(3p), feclearexcept(3p), fetestexcept(3p), isnan(3p),
          sin(3p), tan(3p)
