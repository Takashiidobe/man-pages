...
::
          ...
          fmax, fmaxf, fmaxl — determine maximum numeric value of two
...
::
          ...
          These functions shall determine the maximum numeric value of
          their arguments.  NaN arguments shall be treated as missing data:
          if one argument is a NaN and the other numeric, then these
          functions shall choose the numeric value.
...
::
          ...
          maximum numeric value of their arguments.
