...
gnutls_x509_trust_list_add_crls(3) — Linux manual page
======================================================
...
::
   ...
   gnutls_x509_trust_list_add_crls(3)nutlsnutls_x509_trust_list_add_crls(3)
...
::
          ...
          int gnutls_x509_trust_list_add_crls(gnutls_x509_trust_list_t
          list, const gnutls_x509_crl_t * crl_list, unsigned crl_size,
          unsigned int flags, unsigned int verification_flags);
...
::
   ...
   gnutls                            3.7.2gnutls_x509_trust_list_add_crls(3)
