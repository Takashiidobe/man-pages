...
gnutls_auth_client_get_type(3) — Linux manual page
==================================================
...
::
   ...
   gnutls_auth_client_get_type(3)   gnutls   gnutls_auth_client_get_type(3)
...
::
          ...
          The type of credentials for the client authentication schema, a
...
::
   ...
   gnutls                            3.7.2   gnutls_auth_client_get_type(3)
