...
gnutls_x509_crq_import(3) — Linux manual page
=============================================
...
::
   ...
   gnutls_x509_crq_import(3)        gnutls        gnutls_x509_crq_import(3)
...
::
          ...
          int gnutls_x509_crq_import(gnutls_x509_crq_t crq, const
...
::
          ...
          certificate request to a gnutls_x509_crq_t type.  The output will
          be stored in  crq .
...
::
   ...
   gnutls                            3.7.2        gnutls_x509_crq_import(3)
