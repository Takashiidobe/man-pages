...
pmlookuptext(3) — Linux manual page
===================================
...
::
          ...
          Retrieve descriptive text about the performance metric identified
          by pmid.

          The argument level should be  either PM_TEXT_ONELINE for a one-
          line summary, else PM_TEXT_HELP for a more verbose description,
          suited to a help dialog.
...
::
          ...
          pmLookupDesc(3), pmLookupLabels(3), pmLookupInDomText(3),
...
::
   ...
   Performance Co-Pilot               PCP                   PMLOOKUPTEXT(3)
