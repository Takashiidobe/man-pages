...
gnutls_anon_set_server_known_dh_params(3) — Linux manual page
=============================================================
...
::
   ...
   gnutls_anon_set_server_known_dh_params(3)n_set_server_known_dh_params(3)
...
::
          ...
          int
          gnutls_anon_set_server_known_dh_params(gnutls_anon_server_credentials_t
...
::
   ...
   gnutls                         gnu3t.l7s._2anon_set_server_known_dh_params(3)
