...
gnutls_x509_aki_get_cert_issuer(3) — Linux manual page
======================================================
...
::
   ...
   gnutls_x509_aki_get_cert_issuer(3)nutlsnutls_x509_aki_get_cert_issuer(3)
...
::
          ...
          stored in the  aki type, as well as the
...
::
   ...
   gnutls                            3.7.2gnutls_x509_aki_get_cert_issuer(3)
