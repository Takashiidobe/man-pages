...
gnutls_psk_set_server_params_function(3) — Linux manual page
============================================================
...
::
   ...
   gnutls_psk_set_server_params_function(3)sk_set_server_params_function(3)
...
::
          ...
          the Diffie-Hellman parameters for PSK authentication.  The
...
::
   ...
   gnutls                          gn3u.t7l.s2_psk_set_server_params_function(3)
