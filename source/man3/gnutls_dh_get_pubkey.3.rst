...
gnutls_dh_get_pubkey(3) — Linux manual page
===========================================
...
::
          ...
          int gnutls_dh_get_pubkey(gnutls_session_t session, gnutls_datum_t
          * raw_key);
...
::
          ...
          Diffie-Hellman key exchange.  This function should be used for
...
::
   ...
   gnutls                            3.7.2          gnutls_dh_get_pubkey(3)
