...
::
          ...
          The vdprintf(), vfprintf(), vprintf(), vsnprintf(), and
          vsprintf() functions shall be equivalent to the  dprintf(),
          fprintf(), printf(), snprintf(), and sprintf() functions
          ...
          These functions shall not invoke the va_end macro. As these
          functions invoke the va_arg macro, the value of ap after the
...
`vprintf(3p) <../man3/vprintf.3p.html>`__, 
`vsnprintf(3p) <../man3/vsnprintf.3p.html>`__
