...
acl_get_permset(3) — Linux manual page
======================================
...
::
        ...
        The acl_get_permset() function returns in permset_p a descriptor to
        the permission set in the ACL entry indicated by entry_d.
