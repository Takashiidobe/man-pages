...
::
          ...
          Sends an alert to the peer depending on the error code returned
          by a gnutls function. This function will call
          ...
          success without transmitting any data on error codes that should
          not result to an alert.
...
::
   ...
   gnutls                            3.7.2 gnutls_alert_send_appropriate(3)
