...
gnutls_pkcs11_add_provider(3) — Linux manual page
=================================================
...
::
          ...
          int gnutls_pkcs11_add_provider(const char * name, const char *
          params);
...
::
          ...
          list used in gnutls. After this function is called the module
          will be used for PKCS 11 operations.
...
::
   ...
   gnutls                            3.7.2    gnutls_pkcs11_add_provider(3)
