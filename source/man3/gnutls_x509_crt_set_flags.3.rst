...
gnutls_x509_crt_set_flags(3) — Linux manual page
================================================
...
::
   ...
   gnutls_x509_crt_set_flags(3)     gnutls     gnutls_x509_crt_set_flags(3)
...
::
          ...
          void gnutls_x509_crt_set_flags(gnutls_x509_crt_t cert, unsigned
          int flags);
...
::
   ...
   gnutls                            3.7.2     gnutls_x509_crt_set_flags(3)
