...
gnutls_pem_base64_decode(3) — Linux manual page
===============================================
...
::
          ...
          int gnutls_pem_base64_decode(const char * header, const
...
::
          ...
          const char * header
                      A null terminated string with the PEM header (eg.
                      CERTIFICATE)
...
::
   ...
   gnutls                            3.7.2      gnutls_pem_base64_decode(3)
