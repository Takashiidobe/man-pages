...
gnutls_dh_params_generate2(3) — Linux manual page
=================================================
...
::
          ...
          int gnutls_dh_params_generate2(gnutls_dh_params_t dparams,
          unsigned int bits);
...
::
          ...
          parameters.  See the "Parameter generation" section in the
          manual.
...
::
   ...
   gnutls                            3.7.2    gnutls_dh_params_generate2(3)
