...
fegetexceptflag(3p) — Linux manual page
=======================================
...
::
   ...
   FEGETEXCEPTFLAG(3P)     POSIX Programmer's Manual    FEGETEXCEPTFLAG(3P)
...
::
          ...
          point status flags indicated by the argument excepts to the
          states stored in the object pointed to by flagp.  The value
          pointed to by flagp shall have been set by a previous call to
          fegetexceptflag() whose second argument represented at least
...
::
   ...
   IEEE/The Open Group               2017               FEGETEXCEPTFLAG(3P)
...
`fesetexceptflag(3p) <../man3/fesetexceptflag.3p.html>`__, 
