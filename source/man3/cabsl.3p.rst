...
::
   ...
   CABS(3P)                POSIX Programmer's Manual               CABS(3P)
...
::
          ...
          These functions shall compute the complex absolute value (also
...
::
   ...
   IEEE/The Open Group               2017                          CABS(3P)
