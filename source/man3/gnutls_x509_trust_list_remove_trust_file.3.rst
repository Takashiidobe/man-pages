...
gnutls_x509_trust_list_remove_trust_file(3) — Linux manual page
===============================================================
...
::
   ...
   gnutls_x509_trust_list_remove_trust_file(3)ust_list_remove_trust_file(3)
...
::
          ...
          list, const char * ca_file, gnutls_x509_crt_fmt_t type);
...
::
          ...
          PKCS 11 URLs are also accepted, instead of files, by this
          function.
...
::
   ...
   gnutls                       gnutl3s._7x.5209_trust_list_remove_trust_file(3)
