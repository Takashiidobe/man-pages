...
posix_spawnattr_getsigdefault(3p) — Linux manual page
=====================================================
...
::
   ...
   POSIX_SPAWNATTR_GETSIGDEFAULT(3P)grammer'sIManualNATTR_GETSIGDEFAULT(3P)
...
::
          ...
          get and set the spawn-sigdefault attribute of a spawn attributes
...
::
          ...
          The posix_spawnattr_getsigdefault() function shall obtain the
          ...
          sigdefault attribute in an initialized attributes object
          referenced by attr.

          The spawn-sigdefault attribute represents the set of signals to
          be forced to default signal handling in the new process image (if
          POSIX_SPAWN_SETSIGDEF is set in the spawn-flags attribute) by a
          spawn operation. The default value of this attribute shall be an
          empty signal set.
...
::
          ...
          return zero and store the value of the spawn-sigdefault attribute
          of attr into the object referenced by the sigdefault parameter;
...
::
   ...
   IEEE/The Open Group               2017 POSIX_SPAWNATTR_GETSIGDEFAULT(3P)
...
`posix_spawnattr_setsigdefault(3p) <../man3/posix_spawnattr_setsigdefault.3p.html>`__
