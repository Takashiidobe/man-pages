...
::
   ...
   ISUPPER(3P)             POSIX Programmer's Manual            ISUPPER(3P)
...
::
          ...
          For isupper(): The functionality described on this reference page
          is aligned with the ISO C standard. Any conflict between the
          requirements described here and the ISO C standard is
          unintentional. This volume of POSIX.1‐2017 defers to the ISO C
          standard.

          The isupper() and isupper_l() functions shall test whether c is a
          character of class upper in the current locale, or in the locale
          ...
          The behavior is undefined if the locale argument to isupper_l()
...
::
          ...
          The isupper() and isupper_l() functions shall return non-zero if
...
::
   ...
   IEEE/The Open Group               2017                       ISUPPER(3P)
