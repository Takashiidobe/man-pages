...
gnutls_pkcs11_copy_x509_privkey(3) — Linux manual page
======================================================
...
::
   ...
   gnutls_pkcs11_copy_x509_privkey(3)nutlsnutls_pkcs11_copy_x509_privkey(3)
...
::
          ...
          gnutls_x509_privkey_t key, const char * label, unsigned int
...
::
   ...
   gnutls                            3.7.2gnutls_pkcs11_copy_x509_privkey(3)
