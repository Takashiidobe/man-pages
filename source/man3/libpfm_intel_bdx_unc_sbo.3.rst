...
libpfm_intel_bdx_unc_sbo(3) — Linux manual page
===============================================
...
::
          ...
          libpfm_intel_bdx_unc_sbo - support for Intel Broadwell Server S-
          Box uncore PMU
...
::
          ...
          PMU name: bdx_unc_sbo
          PMU desc: Intel Broadwell Server S-Box uncore PMU
...
::
          ...
          The library supports the Intel Broadwell server Ring Transfer
          unit (S-Box) uncore PMU.  This PMU model only exists on various
