...
::
   ...
   gnutls_x509_trust_list_add_cas(3)gnutlsgnutls_x509_trust_list_add_cas(3)
...
::
          ...
          const gnutls_x509_crt_t * clist, unsigned clist_size, unsigned
          int flags);
...
::
   ...
   gnutls                            3.7.2gnutls_x509_trust_list_add_cas(3)
