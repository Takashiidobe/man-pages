...
gnutls_aead_cipher_decryptv2(3) — Linux manual page
===================================================
...
::
   ...
   gnutls_aead_cipher_decryptv2(3)  gnutls  gnutls_aead_cipher_decryptv2(3)
...
::
          ...
          const void * nonce, size_t nonce_len, const giovec_t * auth_iov,
          int auth_iovcnt, const giovec_t * iov, int iovcnt, void * tag,
          size_t tag_size);
...
::
   ...
   gnutls                            3.7.2  gnutls_aead_cipher_decryptv2(3)
