...
gnutls_privkey_decrypt_data(3) — Linux manual page
==================================================
...
::
          ...
          int gnutls_privkey_decrypt_data(gnutls_privkey_t key, unsigned
...
::
   ...
   gnutls                            3.7.2   gnutls_privkey_decrypt_data(3)
