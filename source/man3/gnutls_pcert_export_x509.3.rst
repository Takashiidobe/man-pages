...
gnutls_pcert_export_x509(3) — Linux manual page
===============================================
...
::
          ...
          GNUTLS_CRT_X509.  When successful, the value written to  crt must
          be freed with gnutls_x509_crt_deinit() when no longer needed.
...
::
   ...
   gnutls                            3.7.2      gnutls_pcert_export_x509(3)
