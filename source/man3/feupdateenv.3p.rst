...
feupdateenv(3p) — Linux manual page
===================================
...
::
          ...
          the object pointed to by envp, and then attempt to raise the
          saved floating-point exceptions. The argument envp shall point to
          an object set by a call to feholdexcept() or fegetenv(), or equal
...
::
          ...
          The following example shows sample code to hide spurious
...
::
   ...
   IEEE/The Open Group               2017                   FEUPDATEENV(3P)
