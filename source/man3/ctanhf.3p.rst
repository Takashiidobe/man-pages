...
::
   ...
   CTANH(3P)               POSIX Programmer's Manual              CTANH(3P)
...
::
          ...
          These functions shall return the complex hyperbolic tangent
          value.
...
::
   ...
   IEEE/The Open Group               2017                         CTANH(3P)
