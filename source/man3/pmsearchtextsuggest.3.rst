...
pmsearchtextsuggest(3) — Linux manual page
==========================================
...
::
   ...
   PMSEARCHTEXTSUGGEST(3)  Library Functions Manual  PMSEARCHTEXTSUGGEST(3)
...
::
          ...
          pmSearchTextSuggest - search for suggestions of metric or
          instance names using PCP search services
...
::
          ...
          int pmSearchTextSuggest(pmSearchSettings *settings,
...
::
          ...
          Executes fulltext search for names of metrics or instances
          suitable for autocompletition, specified by request:
          ...
          query prefix or are within Levenshtein distance of 1, with former
          having slightly higher priority than the latter.
...
::
   ...
   Performance Co-Pilot               PCP            PMSEARCHTEXTSUGGEST(3)
