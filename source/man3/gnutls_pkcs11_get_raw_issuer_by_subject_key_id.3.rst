...
gnutls_pkcs11_get_raw_issuer_by_subject_key_id(3) — Linux manual page
=====================================================================
...
::
   ...
   gnutls_pkcs11_get_raw_issuer_by_subject_key_id(3)er_by_subject_key_id(3)
...
::
          ...
          int gnutls_pkcs11_get_raw_issuer_by_subject_key_id(const char *
          url, const gnutls_datum_t * dn, const gnutls_datum_t * spki,
          gnutls_datum_t * issuer, gnutls_x509_crt_fmt_t fmt, unsigned int
          flags);
...
::
          ...
          The name of the function includes issuer because it can be used
          to discover issuers of certificates.
...
::
   ...
   gnutls                 gnutls_pkcs31.17_.g2et_raw_issuer_by_subject_key_id(3)
