...
::
   ...
   CACOS(3P)               POSIX Programmer's Manual              CACOS(3P)
...
::
          ...
          axis and in the interval [0, π] along the real axis.
...
::
   ...
   IEEE/The Open Group               2017                         CACOS(3P)

--------------

Pages that refer to this page:
`complex.h(0p) <../man0/complex.h.0p.html>`__, 
`cacosl(3p) <../man3/cacosl.3p.html>`__, 
