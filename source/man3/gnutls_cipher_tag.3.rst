...
gnutls_cipher_tag(3) — Linux manual page
========================================
...
::
          ...
          associated data (AEAD) ciphers and will return the output tag.
...
::
   ...
   gnutls                            3.7.2             gnutls_cipher_tag(3)
