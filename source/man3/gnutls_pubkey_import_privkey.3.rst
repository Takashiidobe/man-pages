...
gnutls_pubkey_import_privkey(3) — Linux manual page
===================================================
...
::
          ...
          Note that in certain keys this operation may not be possible,
          e.g., in other than RSA PKCS11 keys.
...
::
   ...
   gnutls                            3.7.2  gnutls_pubkey_import_privkey(3)
