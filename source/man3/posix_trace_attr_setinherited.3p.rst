...
posix_trace_attr_setinherited(3p) — Linux manual page
=====================================================
...
::
   ...
   POSIX_TRACE_ATTR_SETINHERITED(3P)grammer'sIManualE_ATTR_SETINHERITED(3P)
...
::
   ...
   IEEE/The Open Group               2017 POSIX_TRACE_ATTR_SETINHERITED(3P)
