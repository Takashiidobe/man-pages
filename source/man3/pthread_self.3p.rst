...
pthread_self(3p) — Linux manual page
====================================
...
::
          ...
          getpid() function for processes and the rationale is the same:
          the creation call does not provide the thread ID to the created
          thread.
