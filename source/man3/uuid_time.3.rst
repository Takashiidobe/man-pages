...
::
          ...
          time-based UUID uu was created. Note that the UUID creation time
          ...
          created with the uuid_generate_time(3) and
          uuid_generate_time_safe(3) functions. It may or may not work with
...
::
          ...
          1, 1970 GMT (the epoch), is returned (see time(2)). The time at
          which the UUID was created, in seconds and microseconds since the
          epoch, is also stored in the location pointed to by ret_tv (see
          gettimeofday(2)).
...
::
   ...
   util-linux 2.37.85-637cc       2021-04-02                   UUID_TIME(3)
