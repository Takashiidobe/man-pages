...
libpfm_intel_bdw(3) — Linux manual page
=======================================
...
::
          ...
          The library supports the Intel Broadwell core PMU. It should be
...
::
          ...
          The following modifiers are supported on Intel Broadwell
          processors:
...
::
          ...
          Intel Broadwell provides two offcore_response events. They are
          ...
          On Intel Broadwell, the umasks are divided into three categories:
