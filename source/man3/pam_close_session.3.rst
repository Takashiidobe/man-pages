...
pam_close_session(3) — Linux manual page
========================================
...
::
          ...
          authenticated session has ended. The session should have been
          created with a call to pam_open_session(3).
...
::
   ...
   Linux-PAM Manual               04/01/2016           PAM_CLOSE_SESSION(3)
