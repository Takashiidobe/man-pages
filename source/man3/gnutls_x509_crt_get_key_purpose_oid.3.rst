...
gnutls_x509_crt_get_key_purpose_oid(3) — Linux manual page
==========================================================
...
::
   ...
   gnutls_x509_crt_get_key_purpose_oid(3)ss_x509_crt_get_key_purpose_oid(3)
...
::
          ...
          enough, and in that case the *oid_size will be updated with the
...
::
   ...
   gnutls                            3g.n7u.t2ls_x509_crt_get_key_purpose_oid(3)
