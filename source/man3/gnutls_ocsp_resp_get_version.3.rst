...
::
   ...
   gnutls_ocsp_resp_get_version(3)  gnutls  gnutls_ocsp_resp_get_version(3)
...
::
          ...
          version of Basic OCSP response, or a negative error code on
          error.
...
::
   ...
   gnutls                            3.7.2  gnutls_ocsp_resp_get_version(3)
