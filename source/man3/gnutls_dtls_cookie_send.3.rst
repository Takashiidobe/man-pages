...
gnutls_dtls_cookie_send(3) — Linux manual page
==============================================
...
::
          ...
          int gnutls_dtls_cookie_send(gnutls_datum_t * key, void *
...
::
          ...
          gnutls_dtls_prestate_st * prestate
                      The previous cookie returned by
...
::
          ...
          a DTLS server by requiring the client to reply using a cookie
          sent by this function. That way it can be ensured that a client
          we allocated resources for (i.e. gnutls_session_t) is the one
...
::
   ...
   gnutls                            3.7.2       gnutls_dtls_cookie_send(3)
