...
::
   ...
   gnutls_pkcs11_delete_url(3)      gnutls      gnutls_pkcs11_delete_url(3)
...
::
          ...
          int gnutls_pkcs11_delete_url(const char * object_url, unsigned
          int flags);
...
::
          ...
          On success, the number of objects deleted is returned, otherwise
...
::
   ...
   gnutls                            3.7.2      gnutls_pkcs11_delete_url(3)
