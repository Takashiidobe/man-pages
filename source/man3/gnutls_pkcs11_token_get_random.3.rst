...
gnutls_pkcs11_token_get_random(3) — Linux manual page
=====================================================
...
::
   ...
   gnutls_pkcs11_token_get_random(3)gnutlsgnutls_pkcs11_token_get_random(3)
...
::
          ...
          int gnutls_pkcs11_token_get_random(const char * token_url, void *
          rnddata, size_t len);
...
::
          ...
          void * rnddata
                      A pointer to the memory area to be filled with random
                      data
...
::
   ...
   gnutls                            3.7.2gnutls_pkcs11_token_get_random(3)
