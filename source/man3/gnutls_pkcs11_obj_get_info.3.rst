...
gnutls_pkcs11_obj_get_info(3) — Linux manual page
=================================================
...
::
          ...
          size_t * output_size
                      contains the maximum size of the output buffer and
...
::
          ...
          This function will return information about the PKCS11
          certificate such as the label, id as well as token information
...
::
          ...
          GNUTLS_E_SUCCESS (0) on success or a negative error code on
          error.
...
::
   ...
   gnutls                            3.7.2    gnutls_pkcs11_obj_get_info(3)
