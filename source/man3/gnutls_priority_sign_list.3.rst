...
::
   ...
   gnutls_priority_sign_list(3)     gnutls     gnutls_priority_sign_list(3)
...
::
          ...
          int gnutls_priority_sign_list(gnutls_priority_t pcache, const
          unsigned int ** list);
...
::
   ...
   gnutls                            3.7.2     gnutls_priority_sign_list(3)
