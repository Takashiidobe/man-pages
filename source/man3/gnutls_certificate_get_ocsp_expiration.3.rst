...
gnutls_certificate_get_ocsp_expiration(3) — Linux manual page
=============================================================
...
::
   ...
   gnutls_certificate_get_ocsp_expiration(3)tificate_get_ocsp_expiration(3)
...
::
          ...
          time_t
          gnutls_certificate_get_ocsp_expiration(gnutls_certificate_credentials_t
          sc, unsigned idx, int oidx, unsigned flags);
...
::
          ...
          use, thus when reloading, either the credentials structure must
          not be in use by any sessions, or a new credentials structure
          should be allocated for new sessions.

          When  oidx is (-1) then the minimum refresh time for all
          responses is returned. Otherwise the index specifies the response
...
::
   ...
   gnutls                         gnu3t.l7s._2certificate_get_ocsp_expiration(3)
