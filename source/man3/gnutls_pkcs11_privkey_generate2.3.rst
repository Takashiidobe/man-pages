...
gnutls_pkcs11_privkey_generate2(3) — Linux manual page
======================================================
...
::
   ...
   gnutls_pkcs11_privkey_generate2(3)nutlsnutls_pkcs11_privkey_generate2(3)
...
::
          ...
          gnutls_x509_crt_fmt_t fmt, gnutls_datum_t * pubkey, unsigned int
          flags);
...
::
   ...
   gnutls                            3.7.2gnutls_pkcs11_privkey_generate2(3)
