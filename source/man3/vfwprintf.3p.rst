...
vfwprintf(3p) — Linux manual page
=================================
...
::
   ...
   VFWPRINTF(3P)           POSIX Programmer's Manual          VFWPRINTF(3P)
...
::
          ...
          These functions shall not invoke the va_end macro. However, as
          these functions do invoke the va_arg macro, the value of ap after
...
::
          ...
          Section 2.5, Standard I/O Streams, fwprintf(3p)
...
::
   ...
   IEEE/The Open Group               2017                     VFWPRINTF(3P)

--------------

Pages that refer to this page:
`wchar.h(0p) <../man0/wchar.h.0p.html>`__, 
`vswprintf(3p) <../man3/vswprintf.3p.html>`__, 
`vwprintf(3p) <../man3/vwprintf.3p.html>`__
