...
gnutls_privkey_set_flags(3) — Linux manual page
===============================================
...
::
   ...
   gnutls_privkey_set_flags(3)      gnutls      gnutls_privkey_set_flags(3)
...
::
          ...
          void gnutls_privkey_set_flags(gnutls_privkey_t key, unsigned int
          flags);
...
::
   ...
   gnutls                            3.7.2      gnutls_privkey_set_flags(3)
