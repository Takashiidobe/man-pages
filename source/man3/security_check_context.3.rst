...
security_check_context(3) — Linux manual page
=============================================
...
::
   ...
   security_check_context(3)ELinux API documentationcurity_check_context(3)
...
::
          ...
          security_check_context() but does not perform context
          translation.
