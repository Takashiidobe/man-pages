...
gnutls_x509_trust_list_deinit(3) — Linux manual page
====================================================
...
::
   ...
   gnutls_x509_trust_list_deinit(3) gnutls gnutls_x509_trust_list_deinit(3)
...
::
          ...
          unsigned int all
                      if non-zero it will deinitialize all the certificates
                      and CRLs contained in the structure.
...
::
   ...
   gnutls                            3.7.2 gnutls_x509_trust_list_deinit(3)
