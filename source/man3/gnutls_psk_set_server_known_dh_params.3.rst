...
gnutls_psk_set_server_known_dh_params(3) — Linux manual page
============================================================
...
::
   ...
   gnutls_psk_set_server_known_dh_params(3)sk_set_server_known_dh_params(3)
...
::
          ...
          int
          gnutls_psk_set_server_known_dh_params(gnutls_psk_server_credentials_t
...
::
   ...
   gnutls                          gn3u.t7l.s2_psk_set_server_known_dh_params(3)
