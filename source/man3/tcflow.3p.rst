...
::
           ...
           *  If action is TCION and fildes refers to a terminal device,
              the system shall transmit a START character, which is
              intended to cause the terminal device to start transmitting
              data to the system. If fildes is associated with a pseudo-
              terminal, the START character need not be transmitted.
...
::
   ...
   IEEE/The Open Group               2017                        TCFLOW(3P)
