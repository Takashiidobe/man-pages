...
::
   ...
   ISDIGIT(3P)             POSIX Programmer's Manual            ISDIGIT(3P)
...
::
          ...
          For isdigit(): The functionality described on this reference page
          ...
          The behavior is undefined if the locale argument to isdigit_l()
...
::
          ...
          isalnum(3p), isalpha(3p), isblank(3p), iscntrl(3p), isgraph(3p),
