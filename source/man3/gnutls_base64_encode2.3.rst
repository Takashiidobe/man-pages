...
gnutls_base64_encode2(3) — Linux manual page
============================================
...
::
          ...
          using the base64 encoding. This function will allocate the
          required memory to hold the encoded data.
...
::
   ...
   gnutls                            3.7.2         gnutls_base64_encode2(3)
