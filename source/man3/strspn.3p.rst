...
::
          ...
          The strspn() function shall compute the length (in bytes) of the
          maximum initial segment of the string pointed to by s1 which
          consists entirely of bytes from the string pointed to by s2.
...
::
          ...
          The strspn() function shall return the computed length; no return
...
::
   ...
   IEEE/The Open Group               2017                        STRSPN(3P)
