...
libpfm_intel_ivbep_unc_imc(3) — Linux manual page
=================================================
...
::
          ...
          libpfm_intel_ivbep_unc_imc - support for Intel Ivy Bridge-EP
...
::
          ...
          PMU name: ivbep_unc_imc[0-7]
          PMU desc: Intel Ivy Bridge-EP IMC uncore PMU
...
::
          ...
          The library supports the Intel Ivy Bridge Integrated Memory
          Controller (IMC) uncore PMU.  This PMU model only exists on Ivy
          Bridge model 62.
