...
umad_register_oui(3) — Linux manual page
========================================
...
::
          ...
          umad_register_oui() registers the specified class in vendor range
...
::
          ...
          umad_register() returns non-negative agent id number on success,
...
`umad_unregister(3) <../man3/umad_unregister.3.html>`__
