...
gnutls_x509_crl_set_crt_serial(3) — Linux manual page
=====================================================
...
::
   ...
   gnutls_x509_crl_set_crt_serial(3)gnutlsgnutls_x509_crl_set_crt_serial(3)
...
::
          ...
          int gnutls_x509_crl_set_crt_serial(gnutls_x509_crl_t crl, const
...
::
   ...
   gnutls                            3.7.2gnutls_x509_crl_set_crt_serial(3)
