...
gnutls_pkcs7_get_embedded_data(3) — Linux manual page
=====================================================
...
::
   ...
   gnutls_pkcs7_get_embedded_data(3)gnutlsgnutls_pkcs7_get_embedded_data(3)
...
::
          ...
          int gnutls_pkcs7_get_embedded_data(gnutls_pkcs7_t pkcs7, unsigned
          flags, gnutls_datum_t * data);
...
::
   ...
   gnutls                            3.7.2gnutls_pkcs7_get_embedded_data(3)
