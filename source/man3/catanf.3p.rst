...
::
   ...
   CATAN(3P)               POSIX Programmer's Manual              CATAN(3P)
...
::
          ...
          axis and in the interval [-π/2, +π/2] along the real axis.
...
::
   ...
   IEEE/The Open Group               2017                         CATAN(3P)

--------------

Pages that refer to this page:
`complex.h(0p) <../man0/complex.h.0p.html>`__, 
`catanl(3p) <../man3/catanl.3p.html>`__, 
