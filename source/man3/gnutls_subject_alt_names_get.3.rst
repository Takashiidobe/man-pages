...
gnutls_subject_alt_names_get(3) — Linux manual page
===================================================
...
::
          ...
          gnutls_datum_t * san
                      The alternative name data (should be treated as
                      constant)
...
::
          ...
          This function will return a specific alternative name as stored
          in the  sans type. The returned values should be treated as
...
::
   ...
   gnutls                            3.7.2  gnutls_subject_alt_names_get(3)
