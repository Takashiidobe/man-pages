...
gnutls_srp_set_client_credentials_function(3) — Linux manual page
=================================================================
...
::
   ...
   gnutls_srp_set_client_credentials_function(3)ent_credentials_function(3)
...
::
          ...
          The callback function will be called once per handshake before
          the initial hello message is sent.
...
::
   ...
   gnutls                     gnutls_3s.r7p._2set_client_credentials_function(3)
