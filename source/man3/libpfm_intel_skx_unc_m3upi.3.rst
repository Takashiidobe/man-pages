...
libpfm_intel_skx_unc_m3upi(3) — Linux manual page
=================================================
...
::
          ...
          libpfm_intel_skx_unc_m3upi - support for Intel Skylake X Server
          M3UPI uncore PMU
...
::
          ...
          PMU name: skx_unc_m3upi[0-2]
          PMU desc: Intel Skylake X server M3UPI uncore PMU
...
::
          ...
          t      Set the threshold value. When set to a non-zero value, the
                 counter counts the number of M3UPI cycles in which the
