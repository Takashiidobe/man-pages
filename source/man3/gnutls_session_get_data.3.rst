...
gnutls_session_get_data(3) — Linux manual page
==============================================
...
::
   ...
   gnutls_session_get_data(3)       gnutls       gnutls_session_get_data(3)
...
::
          ...
          int gnutls_session_get_data(gnutls_session_t session, void *
...
::
          ...
          size_t * session_data_size
                      is the session_data's size, or it will be set by the
                      function.
...
::
   ...
   gnutls                            3.7.2       gnutls_session_get_data(3)
