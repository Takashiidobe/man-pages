...
gnutls_aead_cipher_encryptv(3) — Linux manual page
==================================================
...
::
          ...
          int auth_iovcnt, size_t tag_size, const giovec_t * iov, int
...
::
          ...
          size_t * ctext_len
                      the length of encrypted data (initially must hold the
...
::
   ...
   gnutls                            3.7.2   gnutls_aead_cipher_encryptv(3)
