...
::
          ...
          before n wide-character codes are exhausted) in the string
          pointed to by pwcs.
...
::
          ...
          The wcswidth() function either shall return 0 (if pwcs points to
          a null wide-character code), or return the number of column
          positions to be occupied by the wide-character string pointed to
          by pwcs, or return -1 (if any of the first n wide-character codes
          in the wide-character string pointed to by pwcs is not a
