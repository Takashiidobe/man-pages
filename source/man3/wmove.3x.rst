...
::
          ...
          y and column x.  This routine does not move the physical cursor
          of the terminal until refresh(3X) is called.  The position
          specified is relative to the upper left-hand corner of the
          window, which is (0,0).
...
::
          ...
          Specifically, they return an error if the window pointer is null,
          or if the position is outside the window.
