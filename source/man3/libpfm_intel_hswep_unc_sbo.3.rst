...
libpfm_intel_hswep_unc_sbo(3) — Linux manual page
=================================================
...
::
          ...
          libpfm_intel_hswep_unc_sbo - support for Intel Haswell-EP S-Box
          uncore PMU
...
::
          ...
          PMU name: hswep_unc_sbo
          PMU desc: Intel Haswell-EP S-Box uncore PMU
...
::
          ...
          The library supports the Intel Haswell Rrint Transfer unit (S-
          Box) uncore PMU.  This PMU model only exists on Haswell model 63.
...
::
          ...
          The following modifiers are supported on Intel Haswell S-Box
          uncore PMU:
