...
gnutls_x509_crt_get_dn_oid(3) — Linux manual page
=================================================
...
::
   ...
   gnutls_x509_crt_get_dn_oid(3)    gnutls    gnutls_x509_crt_get_dn_oid(3)
...
::
          ...
          int gnutls_x509_crt_get_dn_oid(gnutls_x509_crt_t cert, unsigned
...
::
          ...
          Certificate subject specified by the given index.
...
::
   ...
   gnutls                            3.7.2    gnutls_x509_crt_get_dn_oid(3)
