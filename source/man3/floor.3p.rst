...
::
          ...
          These functions shall compute the largest integral value not
          greater than x.
...
::
          ...
          largest integral value not greater than x, expressed as a double,
          float, or long double, as appropriate for the return type of the
          function.
...
::
          ...
          The integral value returned by these functions might not be
...
::
          ...
          ceil(3p), feclearexcept(3p), fetestexcept(3p), isnan(3p)
