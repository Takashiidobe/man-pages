...
gnutls_x509_crq_get_signature_oid(3) — Linux manual page
========================================================
...
::
   ...
   gnutls_x509_crq_get_signature_oid(3)tlstls_x509_crq_get_signature_oid(3)
...
::
          ...
          int gnutls_x509_crq_get_signature_oid(gnutls_x509_crq_t crq, char
          * oid, size_t * oid_size);
...
::
   ...
   gnutls                            3.7g.n2utls_x509_crq_get_signature_oid(3)
