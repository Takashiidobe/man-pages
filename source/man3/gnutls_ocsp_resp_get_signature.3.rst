...
gnutls_ocsp_resp_get_signature(3) — Linux manual page
=====================================================
...
::
   ...
   gnutls_ocsp_resp_get_signature(3)gnutlsgnutls_ocsp_resp_get_signature(3)
...
::
          ...
          This function will extract the signature field of a OCSP
          response.
...
::
   ...
   gnutls                            3.7.2gnutls_ocsp_resp_get_signature(3)
