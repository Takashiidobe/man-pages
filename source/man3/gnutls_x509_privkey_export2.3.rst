...
gnutls_x509_privkey_export2(3) — Linux manual page
==================================================
...
::
   ...
   gnutls_x509_privkey_export2(3)   gnutls   gnutls_x509_privkey_export2(3)
...
::
          ...
          This function will export the private key to a PKCS1 structure
          for RSA or RSA-PSS keys, and integer sequence for DSA keys. Other
          keys types will be exported in PKCS8 form.
...
::
   ...
   gnutls                            3.7.2   gnutls_x509_privkey_export2(3)
