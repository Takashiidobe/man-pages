...
gnutls_x509_trust_list_add_trust_file(3) — Linux manual page
============================================================
...
::
   ...
   gnutls_x509_trust_list_add_trust_file(3)509_trust_list_add_trust_file(3)
...
::
          ...
          specially marked module in p11-kit); the URL "pkcs11:" implies
          all trust databases in the system. Only a single URL specifying
          trust databases can be set; they cannot be stacked with multiple
          calls.
...
::
   ...
   gnutls                          gn3u.t7l.s2_x509_trust_list_add_trust_file(3)
