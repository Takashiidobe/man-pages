...
::
   ...
   DIV(3P)                 POSIX Programmer's Manual                DIV(3P)
...
::
          ...
          The div() function shall compute the quotient and remainder of
          the division of the numerator numer by the denominator denom.  If
          the division is inexact, the resulting quotient is the integer of
...
::
          ...
          includes the following members, in any order:
...
::
   ...
   IEEE/The Open Group               2017                           DIV(3P)
