...
libpfm_intel_hswep_unc_irp(3) — Linux manual page
=================================================
...
::
          ...
          libpfm_intel_hswep_unc_irp - support for Intel Haswell-EP IRP
          uncore PMU
...
::
          ...
          PMU name: hswep_unc_irp
          PMU desc: Intel Haswell-EP IRP uncore PMU
...
::
          ...
          The library supports the Intel Haswell uncore PMU.  This PMU
          model only exists on Haswell model 63.
...
::
          ...
          The following modifiers are supported on Intel Haswell IRP uncore
          PMU:
          ...
          t      Set the threshold value. When set to a non-zero value, the
                 counter counts the number of cycles in which the number of
                 occurrences of the event is greater or equal to the
