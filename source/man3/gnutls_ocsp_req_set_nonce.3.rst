...
gnutls_ocsp_req_set_nonce(3) — Linux manual page
================================================
...
::
          ...
          int gnutls_ocsp_req_set_nonce(gnutls_ocsp_req_t req, unsigned int
          critical, const gnutls_datum_t * nonce);
...
::
   ...
   gnutls                            3.7.2     gnutls_ocsp_req_set_nonce(3)
