...
capng_set_rootid(3) — Linux manual page
=======================================
...
::
          ...
          capng_set_rootid sets the rootid for capabilities operations.
...
::
          ...
          On success, it returns 0. It returns -1 if there is an internal
          error or the kernel does not suppor V3 filesystem capabilities.
...
::
   ...
   Red Hat                         Sept 2020            CAPNG_SET_ROOTID(3)
