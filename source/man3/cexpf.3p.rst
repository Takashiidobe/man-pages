...
::
   ...
   CEXP(3P)                POSIX Programmer's Manual               CEXP(3P)
...
::
          ...
          These functions shall compute the complex exponent of z, defined
          as ez.
...
::
   ...
   IEEE/The Open Group               2017                          CEXP(3P)
