...
gnutls_certificate_set_x509_simple_pkcs12_file(3) — Linux manual page
=====================================================================
...
::
   ...
   gnutls_certificate_set_x509_simple_pkcs12_file(3)9_simple_pkcs12_file(3)
...
::
          ...
          res, const char * pkcs12file, gnutls_x509_crt_fmt_t type, const
          char * password);
...
::
          ...
          PKCS12 files with a MAC, encrypted bags and PKCS 8 private keys
          are supported. However, only password based security, and the
...
::
   ...
   gnutls                 gnutls_cert3i.f7i.c2ate_set_x509_simple_pkcs12_file(3)
