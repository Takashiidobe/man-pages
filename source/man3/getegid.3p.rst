...
::
   ...
   GETEGID(3P)             POSIX Programmer's Manual            GETEGID(3P)
...
::
          ...
          The getegid() function shall always be successful and no return
...
::
          ...
          geteuid(3p), getgid(3p), getuid(3p), setegid(3p), seteuid(3p),
...
::
   ...
   IEEE/The Open Group               2017                       GETEGID(3P)
