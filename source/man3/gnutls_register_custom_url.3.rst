...
gnutls_register_custom_url(3) — Linux manual page
=================================================
...
::
          ...
          GnuTLS 3.5.0 this function can be used to override the builtin
          URLs.
...
::
          ...
          returns zero if the given structure was imported or a negative
          value otherwise.
...
::
   ...
   gnutls                            3.7.2    gnutls_register_custom_url(3)
