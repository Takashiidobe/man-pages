...
if_freenameindex(3p) — Linux manual page
========================================
...
::
          ...
          The if_freenameindex() function shall free the memory allocated
          by if_nameindex().  The ptr argument shall be a pointer that was
          returned by if_nameindex().  After if_freenameindex() has been
          called, the application shall not use the array of which ptr is
          the address.
...
::
          ...
          getsockopt(3p), if_indextoname(3p), if_nameindex(3p),
...
::
   ...
   IEEE/The Open Group               2017              IF_FREENAMEINDEX(3P)

--------------

Pages that refer to this page:
`net_if.h(0p) <../man0/net_if.h.0p.html>`__, 
