...
capng_apply_caps_fd(3) — Linux manual page
==========================================
...
::
          ...
          This function will write the file based capabilities to the
...
::
          ...
          This returns 0 on success, -1 if something besides a regular file
          is passed, and -2 if a non-root namespace id is being used for
          rootid.
