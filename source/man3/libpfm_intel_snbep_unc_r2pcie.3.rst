...
libpfm_intel_snbep_unc_r2pcie(3) — Linux manual page
====================================================
...
::
          ...
          libpfm_intel_snbep_unc_r2pcie - support for Intel Sandy Bridge-EP
          R2 PCIe  uncore PMU
...
::
          ...
          PMU name: snbep_unc_r2pcie
          PMU desc: Intel Sandy Bridge-EP R2 PCIe uncore PMU
...
::
          ...
          This PMU model only exists on Sandy Bridge model 45. There is
          only one R2PCIe PMU per processor socket.
...
::
          ...
          i      Invert the meaning of the event. The counter will now
                 count R2 PCIe cycles in which the event is not occurring.
          ...
          t      Set the threshold value. When set to a non-zero value, the
                 counter counts the number of R2PCIe cycles in which the
