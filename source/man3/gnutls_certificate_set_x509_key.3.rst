...
gnutls_certificate_set_x509_key(3) — Linux manual page
======================================================
...
::
   ...
   gnutls_certificate_set_x509_key(3)nutlsnutls_certificate_set_x509_key(3)
...
::
          ...
          int
          gnutls_certificate_set_x509_key(gnutls_certificate_credentials_t
...
::
          ...
          for the server.  For clients that wants to send more than their
          own end entity certificate (e.g., also an intermediate CA cert)
          then put the certificate chain in  cert_list .
...
::
   ...
   gnutls                            3.7.2gnutls_certificate_set_x509_key(3)
