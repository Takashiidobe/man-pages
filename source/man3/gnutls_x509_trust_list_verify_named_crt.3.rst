...
gnutls_x509_trust_list_verify_named_crt(3) — Linux manual page
==============================================================
...
::
   ...
   gnutls_x509_trust_list_verify_named_crt(3)trust_list_verify_named_crt(3)
...
::
          ...
          int
          gnutls_x509_trust_list_verify_named_crt(gnutls_x509_trust_list_t
          list, gnutls_x509_crt_t cert, const void * name, size_t
          name_size, unsigned int flags, unsigned int * voutput,
...
::
   ...
   gnutls                        gnut3l.s7_.x2509_trust_list_verify_named_crt(3)
