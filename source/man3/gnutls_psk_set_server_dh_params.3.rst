...
gnutls_psk_set_server_dh_params(3) — Linux manual page
======================================================
...
::
   ...
   gnutls_psk_set_server_dh_params(3)nutlsnutls_psk_set_server_dh_params(3)
...
::
          ...
          void
          gnutls_psk_set_server_dh_params(gnutls_psk_server_credentials_t
...
::
   ...
   gnutls                            3.7.2gnutls_psk_set_server_dh_params(3)
