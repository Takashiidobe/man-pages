...
gnutls_x509_crq_set_attribute_by_oid(3) — Linux manual page
===========================================================
...
::
   ...
   gnutls_x509_crq_set_attribute_by_oid(3)_x509_crq_set_attribute_by_oid(3)
...
::
          ...
          const char * oid, void * buf, size_t buf_size);
...
::
          ...
          void * buf  a pointer to a structure that holds the attribute
                      data
...
::
   ...
   gnutls                           g3n.u7t.l2s_x509_crq_set_attribute_by_oid(3)
