...
gnutls_load_file(3) — Linux manual page
=======================================
...
::
          ...
          int gnutls_load_file(const char * filename, gnutls_datum_t *
          data);
...
::
          ...
          the reading fails in the middle, the partially loaded content
          might remain on memory.
...
::
   ...
   gnutls                            3.7.2              gnutls_load_file(3)
