...
pcap_dump(3pcap) — Linux manual page
====================================
...
::
          ...
          pcap_dump_open(3PCAP).  Note that its calling arguments are
          suitable for use with pcap_dispatch(3PCAP) or pcap_loop(3PCAP).
          If called directly, the user parameter is of type pcap_dumper_t
          as returned by pcap_dump_open().
