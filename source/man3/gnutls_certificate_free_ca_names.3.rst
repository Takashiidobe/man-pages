...
gnutls_certificate_free_ca_names(3) — Linux manual page
=======================================================
...
::
   ...
   gnutls_certificate_free_ca_names(3)utlsutls_certificate_free_ca_names(3)
...
::
          ...
          void
          gnutls_certificate_free_ca_names(gnutls_certificate_credentials_t
          sc);
...
::
   ...
   gnutls                            3.7.g2nutls_certificate_free_ca_names(3)
