...
gnutls_certificate_set_verify_limits(3) — Linux manual page
===========================================================
...
::
   ...
   gnutls_certificate_set_verify_limits(3)_certificate_set_verify_limits(3)
...
::
          ...
          unsigned int max_bits
                      is the number of bits of an acceptable certificate
                      (default 8200)

          unsigned int max_depth
                      is maximum depth of the verification of a certificate
                      chain (default 5)
...
::
   ...
   gnutls                           g3n.u7t.l2s_certificate_set_verify_limits(3)
