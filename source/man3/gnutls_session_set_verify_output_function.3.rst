...
gnutls_session_set_verify_output_function(3) — Linux manual page
================================================================
...
::
   ...
   gnutls_session_set_verify_output_function(3)et_verify_output_function(3)
...
::
          ...
          void gnutls_session_set_verify_output_function(gnutls_session_t
          session, gnutls_verify_output_function * func);
...
::
          ...
          the certificate verification procedure.  To verify the
          certificate chain and print its path uptp the trusted root,
          functions such as gnutls_certificate_verify_peers(),
          gnutls_x509_trust_list_verify_crt(), and
          gnutls_x509_trust_list_verify_crt2() can be used. The callback is
          set in _gnutls_verify_crt_status() and
...
::
   ...
   gnutls                      gnutls3_.s7e.s2sion_set_verify_output_function(3)
