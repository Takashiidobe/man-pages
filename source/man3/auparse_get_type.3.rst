...
auparse_get_type(3) — Linux manual page
=======================================
...
::
          ...
          auparse_get_type will return the integer value for the current
...
::
          ...
          auparse_get_type returns 0 if an error occurs; otherwise, the
          record's type.
