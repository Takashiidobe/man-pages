...
gnutls_x509_privkey_get_seed(3) — Linux manual page
===================================================
...
::
   ...
   gnutls_x509_privkey_get_seed(3)  gnutls  gnutls_x509_privkey_get_seed(3)
...
::
          ...
          gnutls_digest_algorithm_t * digest
                      if non-NULL it will contain the digest algorithm used
                      for key generation (if applicable)

          void * seed where seed will be copied to

          size_t * seed_size
                      originally holds the size of  seed , will be updated
                      with actual size
...
::
   ...
   gnutls                            3.7.2  gnutls_x509_privkey_get_seed(3)
