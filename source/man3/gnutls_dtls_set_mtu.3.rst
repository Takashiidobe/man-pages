...
gnutls_dtls_set_mtu(3) — Linux manual page
==========================================
...
::
          ...
          void gnutls_dtls_set_mtu(gnutls_session_t session, unsigned int
          mtu);
...
::
          ...
          Ethernet device with MTU 1500, the DTLS MTU set with this
          function would be 1500 - 40 (IPV6 header) - 8 (UDP header) =
          1452.
...
::
   ...
   gnutls                            3.7.2           gnutls_dtls_set_mtu(3)
