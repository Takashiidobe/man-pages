...
gnutls_digest_list(3) — Linux manual page
=========================================
...
::
   ...
   gnutls_digest_list(3)            gnutls            gnutls_digest_list(3)
...
::
          ...
          Return a (0)-terminated list of gnutls_digest_algorithm_t
...
::
   ...
   gnutls                            3.7.2            gnutls_digest_list(3)
