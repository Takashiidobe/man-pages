...
libpfm_intel_bdx_unc_ha(3) — Linux manual page
==============================================
...
::
          ...
          libpfm_intel_bdx_unc_ha - support for Intel Broadwell Server Home
          Agent (HA) uncore PMU
...
::
          ...
          PMU name: bdx_unc_ha0, bdx_unc_ha1
          PMU desc: Intel Broadwell Server HA uncore PMU
...
::
          ...
          The library supports the Intel Broadwell Server Home Agent (HA)
          uncore PMU.  This PMU model only exists on various Broadwell
          models (79, 86).
