...
gnutls_psk_server_get_username2(3) — Linux manual page
======================================================
...
::
   ...
   gnutls_psk_server_get_username2(3)nutlsnutls_psk_server_get_username2(3)
...
::
          ...
          Return a pointer to the username of the peer in the supplied
          datum. Does not need to be null-terminated.
...
::
   ...
   gnutls                            3.7.2gnutls_psk_server_get_username2(3)
