...
libpfm_intel_bdx_unc_irp(3) — Linux manual page
===============================================
...
::
          ...
          libpfm_intel_bdx_unc_irp - support for Intel Broadwell Server IRP
          uncore PMU
...
::
          ...
          PMU name: bdx_unc_irp
          PMU desc: Intel Broadwell Server IRP uncore PMU
...
::
          ...
          The library supports the Intel Broadwell Server IRP (IIO
          coherency) uncore PMU .  This PMU model only exists various
          Broadwell server models (79, 86).
