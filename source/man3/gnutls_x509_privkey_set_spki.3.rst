...
gnutls_x509_privkey_set_spki(3) — Linux manual page
===================================================
...
::
   ...
   gnutls_x509_privkey_set_spki(3)  gnutls  gnutls_x509_privkey_set_spki(3)
...
::
          ...
          int gnutls_x509_privkey_set_spki(gnutls_x509_privkey_t key, const
...
::
   ...
   gnutls                            3.7.2  gnutls_x509_privkey_set_spki(3)
