...
form_hook(3x) — Linux manual page
=================================
...
::
          ...
          The function set_form_term sets a hook to be called at form-
          unpost time and just before a page change once it is posted.
          form_init returns the current form term hook, if any (NULL if
          there is no such hook).
