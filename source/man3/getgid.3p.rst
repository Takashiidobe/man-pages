...
::
          ...
          The getgid() function shall always be successful and no return
...
::
          ...
          In a conforming environment, getgid() will always succeed. It is
...
::
          ...
          getegid(3p), geteuid(3p), getuid(3p), setegid(3p), seteuid(3p),
