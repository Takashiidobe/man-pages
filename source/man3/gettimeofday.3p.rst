...
gettimeofday(3p) — Linux manual page
====================================
...
::
          ...
          Applications should use the clock_gettime() function instead of
          the obsolescent gettimeofday() function.
...
::
          ...
          clock_getres(3p), ctime(3p)

          The Base Definitions volume of POSIX.1‐2017, sys_time.h(0p)
