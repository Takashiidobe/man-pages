...
gnutls_ocsp_resp_export2(3) — Linux manual page
===============================================
...
::
   ...
   gnutls_ocsp_resp_export2(3)      gnutls      gnutls_ocsp_resp_export2(3)
...
::
          ...
          gnutls_datum_t * data
                      newly allocate buffer holding DER or PEM encoded OCSP
                      response
...
::
   ...
   gnutls                            3.7.2      gnutls_ocsp_resp_export2(3)
