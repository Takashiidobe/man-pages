...
gnutls_psk_allocate_server_credentials(3) — Linux manual page
=============================================================
...
::
   ...
   gnutls_psk_allocate_server_credentials(3)_allocate_server_credentials(3)
...
::
          ...
          gnutls_psk_server_credentials_t *            sc
                      is a pointer to a gnutls_psk_server_credentials_t
                      type.
...
::
   ...
   gnutls                         gnu3t.l7s._2psk_allocate_server_credentials(3)
