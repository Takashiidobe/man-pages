...
::
          ...
          wide-character string pointed to by ws1 of any wide-character
          code from the wide-character string pointed to by ws2.
...
::
          ...
          Upon successful completion, wcspbrk() shall return a pointer to
          the wide-character code or a null pointer if no wide-character
