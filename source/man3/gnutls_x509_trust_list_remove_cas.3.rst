...
gnutls_x509_trust_list_remove_cas(3) — Linux manual page
========================================================
...
::
   ...
   gnutls_x509_trust_list_remove_cas(3)tlstls_x509_trust_list_remove_cas(3)
...
::
          ...
          list, const gnutls_x509_crt_t * clist, unsigned clist_size);
...
::
   ...
   gnutls                            3.7g.n2utls_x509_trust_list_remove_cas(3)
