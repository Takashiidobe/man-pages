...
gnutls_anti_replay_set_window(3) — Linux manual page
====================================================
...
::
          ...
          void gnutls_anti_replay_set_window(gnutls_anti_replay_t
...
::
          ...
          unsigned int window
                      is the time window recording ClientHello, in
                      milliseconds
...
::
          ...
          considers it a replay when a ClientHello outside of the period;
          if a ClientHello arrives within this period, the server checks
          the database and detects duplicates.
...
::
   ...
   gnutls                            3.7.2 gnutls_anti_replay_set_window(3)
