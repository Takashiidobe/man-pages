...
pcap_set_rfmon(3pcap) — Linux manual page
=========================================
...
::
          ...
          pcap_set_rfmon() sets whether monitor mode should be set on a
          capture handle when the handle is activated.  If rfmon is non-
...
::
          ...
          pcap_set_rfmon() returns 0 on success or PCAP_ERROR_ACTIVATED if
