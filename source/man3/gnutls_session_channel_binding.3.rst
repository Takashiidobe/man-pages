...
gnutls_session_channel_binding(3) — Linux manual page
=====================================================
...
::
   ...
   gnutls_session_channel_binding(3)gnutlsgnutls_session_channel_binding(3)
...
::
          ...
          GNUTLS_E_SUCCESS on success, GNUTLS_E_UNIMPLEMENTED_FEATURE if
          the  cbtype is unsupported,
...
::
   ...
   gnutls                            3.7.2gnutls_session_channel_binding(3)
