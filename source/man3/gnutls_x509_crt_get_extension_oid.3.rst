...
gnutls_x509_crt_get_extension_oid(3) — Linux manual page
========================================================
...
::
   ...
   gnutls_x509_crt_get_extension_oid(3)tlstls_x509_crt_get_extension_oid(3)
...
::
          ...
          void * oid  a pointer to a structure to hold the OID (may be
                      null)
...
::
   ...
   gnutls                            3.7g.n2utls_x509_crt_get_extension_oid(3)
