...
auparse_get_field_int(3) — Linux manual page
============================================
...
::
          ...
          auparse_get_field_int allows access to the value as an int of the
          current field of the current record in the current event.
...
::
          ...
          Returns -1 if there is an error with errno set appropriately or
          the value if errno is zero.
...
::
   ...
   Red Hat                         Feb 2007        AUPARSE_GET_FIELD_INT(3)
