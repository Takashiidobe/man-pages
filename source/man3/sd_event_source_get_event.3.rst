...
::
   ...
   SD_EVENT_SOURCE_GET_EVENT(3)vent_source_get_eventENT_SOURCE_GET_EVENT(3)
...
::
   ...
   systemd 249                                 SD_EVENT_SOURCE_GET_EVENT(3)

--------------

Pages that refer to this page: `sd-event(3) <../man3/sd-event.3.html>`__
