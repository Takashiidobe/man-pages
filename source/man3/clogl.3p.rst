...
::
          ...
          These functions shall compute the complex natural (base e)
...
::
          ...
          in the range of a strip mathematically unbounded along the real
          axis and in the interval [-iπ, +iπ] along the imaginary axis.
