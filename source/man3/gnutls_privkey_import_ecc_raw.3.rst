...
gnutls_privkey_import_ecc_raw(3) — Linux manual page
====================================================
...
::
   ...
   gnutls_privkey_import_ecc_raw(3) gnutls gnutls_privkey_import_ecc_raw(3)
...
::
          ...
          In EdDSA curves the  y parameter should be NULL and the  x and  k
          parameters must be in the native format for the curve.
...
::
   ...
   gnutls                            3.7.2 gnutls_privkey_import_ecc_raw(3)
