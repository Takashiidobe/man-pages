...
gnutls_set_default_priority(3) — Linux manual page
==================================================
...
::
          ...
          and macs. This is the recommended method of setting the defaults,
          in order to promote consistency between applications using
          GnuTLS, and to allow GnuTLS using applications to update settings
          ...
          For an application to specify additional options to priority
          string consider using gnutls_set_default_priority_append().
...
::
   ...
   gnutls                            3.7.2   gnutls_set_default_priority(3)
