...
gnutls_pk_bits_to_sec_param(3) — Linux manual page
==================================================
...
::
   ...
   gnutls_pk_bits_to_sec_param(3)   gnutls   gnutls_pk_bits_to_sec_param(3)
...
::
          ...
          gnutls_sec_param_t
          gnutls_pk_bits_to_sec_param(gnutls_pk_algorithm_t algo, unsigned
          int bits);
...
::
   ...
   gnutls                            3.7.2   gnutls_pk_bits_to_sec_param(3)
