...
::
   ...
   FERROR(3P)              POSIX Programmer's Manual             FERROR(3P)
...
::
          ...
          The ferror() function shall test the error indicator for the
          stream pointed to by stream.

          The ferror() function shall not change the setting of errno if
          stream is valid.
...
::
   ...
   IEEE/The Open Group               2017                        FERROR(3P)
