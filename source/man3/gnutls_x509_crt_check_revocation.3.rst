...
gnutls_x509_crt_check_revocation(3) — Linux manual page
=======================================================
...
::
   ...
   gnutls_x509_crt_check_revocation(3)utlsutls_x509_crt_check_revocation(3)
...
::
          ...
          const gnutls_x509_crl_t * crl_list, unsigned crl_list_length);
...
::
          ...
          0 if the certificate is NOT revoked, and 1 if it is.  A negative
...
::
   ...
   gnutls                            3.7.g2nutls_x509_crt_check_revocation(3)
