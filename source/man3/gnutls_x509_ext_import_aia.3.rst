...
::
          ...
          extension from the provided DER-encoded data; see RFC 5280
          section 4.2.2.1 for more information on the extension.  The AIA
...
::
   ...
   gnutls                            3.7.2    gnutls_x509_ext_import_aia(3)
