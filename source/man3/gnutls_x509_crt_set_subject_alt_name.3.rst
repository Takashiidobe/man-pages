...
gnutls_x509_crt_set_subject_alt_name(3) — Linux manual page
===========================================================
...
::
   ...
   gnutls_x509_crt_set_subject_alt_name(3)_x509_crt_set_subject_alt_name(3)
...
::
          ...
          gnutls_x509_subject_alt_name_t type, const void * data, unsigned
...
::
          ...
          GNUTLS_SAN_URI as a text string, GNUTLS_SAN_IPADDRESS as a binary
          IP address (4 or 16 bytes), GNUTLS_SAN_OTHERNAME_XMPP as a UTF8
          string (since 3.5.0).

          Since version 3.5.7 the GNUTLS_SAN_RFC822NAME,
          GNUTLS_SAN_DNSNAME, and GNUTLS_SAN_OTHERNAME_XMPP are converted
...
::
   ...
   gnutls                           g3n.u7t.l2s_x509_crt_set_subject_alt_name(3)
