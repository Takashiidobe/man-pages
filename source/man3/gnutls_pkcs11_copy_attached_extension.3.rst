...
gnutls_pkcs11_copy_attached_extension(3) — Linux manual page
============================================================
...
::
   ...
   gnutls_pkcs11_copy_attached_extension(3)kcs11_copy_attached_extension(3)
...
::
          ...
          gnutls_x509_crt_t crt, gnutls_datum_t * data, const char * label,
          unsigned int flags);
...
::
   ...
   gnutls                          gn3u.t7l.s2_pkcs11_copy_attached_extension(3)
