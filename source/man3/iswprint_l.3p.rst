...
::
          ...
          For iswprint(): The functionality described on this reference
          page is aligned with the ISO C standard. Any conflict between the
          requirements described here and the ISO C standard is
          unintentional. This volume of POSIX.1‐2017 defers to the ISO C
          standard.

          The iswprint() and iswprint_l() functions shall test whether wc
          is a wide-character code representing a character of class print
          ...
          The behavior is undefined if the locale argument to iswprint_l()
...
::
          ...
          The iswprint() and iswprint_l() functions shall return non-zero
          if wc is a printable wide-character code; otherwise, they shall
          return 0.
...
::
          ...
          iswdigit(3p), iswgraph(3p), iswlower(3p), iswpunct(3p),
