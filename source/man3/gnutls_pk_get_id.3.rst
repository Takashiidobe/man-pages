...
gnutls_pk_get_id(3) — Linux manual page
=======================================
...
::
   ...
   gnutls_pk_get_id(3)              gnutls              gnutls_pk_get_id(3)
...
::
          ...
          a gnutls_pk_algorithm_t id of the specified public key algorithm
          string, or GNUTLS_PK_UNKNOWN on failures.
...
::
   ...
   gnutls                            3.7.2              gnutls_pk_get_id(3)
