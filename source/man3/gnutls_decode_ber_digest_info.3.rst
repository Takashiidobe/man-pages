...
gnutls_decode_ber_digest_info(3) — Linux manual page
====================================================
...
::
          ...
          gnutls_digest_algorithm_t * hash, unsigned char * digest,
...
::
          ...
          unsigned int * digest_size
                      will contain the hash size of the structure;
                      initially must hold the maximum size of  digest
...
::
   ...
   gnutls                            3.7.2 gnutls_decode_ber_digest_info(3)
