...
::
          ...
          int gnutls_pkcs7_get_crl_raw(gnutls_pkcs7_t pkcs7, unsigned indx,
          void * crl, size_t * crl_size);
...
::
          ...
          void * crl  the contents of the crl will be copied there (may be
                      null)
...
::
   ...
   gnutls                            3.7.2      gnutls_pkcs7_get_crl_raw(3)
