...
gnutls_certificate_get_x509_key(3) — Linux manual page
======================================================
...
::
   ...
   gnutls_certificate_get_x509_key(3)nutlsnutls_certificate_get_x509_key(3)
...
::
          ...
          int
          gnutls_certificate_get_x509_key(gnutls_certificate_credentials_t
          res, unsigned index, gnutls_x509_privkey_t * key);
...
::
          ...
          deallocated with gnutls_x509_privkey_deinit() when no longer
          needed.
...
::
   ...
   gnutls                            3.7.2gnutls_certificate_get_x509_key(3)
